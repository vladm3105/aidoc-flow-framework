...
**Example 2: Greeks Calculation ⏭️ Skip CTR**
...
### Example 2: Bug Fix - Greeks Calculation ⏭️ Skip IMPL

**Criteria Met**:
- Duration: 3 days
- Teams: 1 (single developer)
- Components: 1 (Greeks Calculator service)
...
- [IMPL-TEMPLATE.md](impl_plans/IMPL-TEMPLATE.md) - Full IMPL template
- [IMPL-000_index.md](impl_plans/IMPL-000_index.md) - IMPL document index
- [SPEC-TEMPLATE.yaml](specs/SPEC-TEMPLATE.yaml) - Technical specification template
