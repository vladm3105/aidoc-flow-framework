...
- **Input**: BRD, PRD, EARS (business requirements and event-driven specs)
...
**Functional Areas**:
- **API Integrations**: External service integrations (IB Gateway, Alpha Vantage)
- **Risk Management**: Position limits, risk validation, circuit breakers
- **ML Models**: Market regime classifier, sentiment analysis, ensemble signals
- **Trading Strategies**: Covered calls, covered puts, iron condors, portfolio hedging
...
**Tagging Strategy**:
```gherkin
@requirement:[REQ-NNN](../reqs/.../REQ-NNN.md)
@adr:[ADR-NNN](../adrs/ADR-NNN.md)
@spec:[SPEC-NNN](../specs/.../SPEC-NNN.yaml)
...
Example format:
- **BDD-001**: [Interactive Brokers Gateway Integration](./BDD-001_ib_gateway_integration.feature)
  - **Requirements**: REQ-026 (Alpha Vantage Integration), REQ-XXX (IB Gateway)
  - **ADRs**: ADR-030 (IB Gateway Architecture)
  - **Status**: Pending
...
Example format:
- **BDD-002**: [Position Risk Limits Validation](./BDD-002_position_risk_limits.feature)
...
Example format:
- **BDD-003**: [Market Regime Classifier Behavior](./BDD-003_market_regime_classifier.feature)
...
*[BDD scenarios for options trading strategies will be listed here]*

Example format:
- **BDD-004**: [Covered Call Strategy Execution](./BDD-004_covered_call_strategy.feature)
...
|--------|----------------|-------------------------------|
| [BDD-NNN](../../bbds/BDD-NNN_slug.feature) | Feature: Title | Primary functional criteria |
| [BDD-NNN](../../bbds/BDD-NNN_slug.feature#scenario-1) | Scenario: Specific | Specific acceptance criterion |
```
...
|---------------|-------------|--------------|
| ADR | [ADR-NNN](../adrs/ADR-NNN.md) | Architecture decisions must satisfy BDD scenarios |
| SYS | [SYS-NNN](../sys/SYS-NNN.md) | System requirements traced from BDD scenarios |
| REQ | [REQ-NNN](../reqs/.../REQ-NNN.md) | Atomic requirements validated by BDD scenarios |
| SPEC | [SPEC-NNN](../specs/.../SPEC-NNN.yaml) | Technical specs implement BDD acceptance criteria |
...
- [REQ-TEMPLATE.md](../reqs/REQ-TEMPLATE.md): Requirements template (BDD validates requirements)
- [SPEC-TEMPLATE.yaml](../specs/SPEC-TEMPLATE.yaml): Technical specs template (implements BDD scenarios)
- [TASKS-TEMPLATE.md](../ai_tasks/TASKS-TEMPLATE.md): Code generation template (generates BDD test code)
