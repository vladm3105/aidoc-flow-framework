...
|-------------|-------------|----------------|-------------------|--------------|
| BRD | [BRD-NNN](../brds/BRD-NNN_...md) | [Business requirement title] | Sections X.Y | Business objectives driving these requirements |
...
|---------------|-------------|----------------|--------------|
| ADR | [ADR-NNN](../adrs/ADR-NNN_...md#ADR-NNN) | [Architecture decision title] | Architectural approach implementing these requirements |
| REQ | [REQ-NNN](../reqs/.../REQ-NNN_...md#REQ-NNN) | [Detailed requirement] | Detailed atomic requirement |
| IMPL | [IMPL-NNN](../impl_plans/IMPL-NNN_...md#IMPL-NNN) | [Implementation plan] | Project management plan (WHO/WHEN) |
| CTR | [CTR-NNN](../contracts/CTR-NNN_...md#CTR-NNN) | [API contract] | Interface contract (if interface requirement) |
| BDD | [BDD-NNN](../bbds/BDD-NNN_...feature#scenarios) | [Test scenarios] | Acceptance test scenarios |
| SPEC | [SPEC-NNN](../specs/.../SPEC-NNN_...yaml) | [Technical specification] | Implementation blueprint (HOW to build) |
| TASKS | [TASKS-NNN](../ai_tasks/TASKS-NNN_...md) | [Code generation plan] | Exact TODOs to implement SPEC in code |
...
| Source Type | Document ID | Document Title | Relevant Sections | Relationship |
|-------------|-------------|----------------|-------------------|--------------|
| BRD | [BRD-001](../brds/BRD-001_trading_platform.md) | Trading Platform Requirements | Sections 2.4, 4.x | Business objectives driving these requirements |
| PRD | [PRD-001](../prd/PRD-001_risk_management.md) | Risk Management Product Requirements | Functional Requirements 4.x | Product features and user needs |
| SYS | [SYS-001](../sys/SYS-001_position_limits.md) | Position Limit System Requirements | System architecture section 3 | Technical system constraints |

**Key Business Objectives Satisfied**:
- BO-001: Prevent excessive portfolio heat → Satisfied by EARS statements EVENT-001, EVENT-002
...
|--------|-----------|-------------------------|--------------|
| [ADR-033](../adrs/ADR-033_risk_limit_enforcement.md#ADR-033) | Risk Limit Enforcement Architecture | EARS statements EVENT-001, STATE-001 | This EARS requirement necessitates the architectural approach |
| [ADR-034](../adrs/ADR-034_circuit_breaker.md#ADR-034) | Circuit Breaker Pattern | EARS NFR-PERF-001 | Performance requirement drives architectural pattern |

#### 7.2.2 Atomic Requirements

| REQ ID | Requirement Title | Source EARS Statements | Relationship |
|--------|------------------|----------------------|--------------|
| [REQ-003](../reqs/risk/lim/REQ-003_position_limit.md#REQ-003) | Position Limit Validation | Derived from EARS EVENT-001, EVENT-002 | Detailed implementation requirement |
| [REQ-004](../reqs/risk/lim/REQ-004_portfolio_heat.md#REQ-004) | Portfolio Heat Calculation | Derived from EARS STATE-001 | Detailed implementation requirement |

#### 7.2.3 BDD Scenarios

| BDD Feature | Scenario | Source EARS Statements | Relationship |
|-------------|----------|----------------------|--------------|
| [BDD-003](../bbds/BDD-003_risk_limits.feature#scenario-1) | Validate position limit rejection | Tests EARS EVENT-001 | Acceptance test for requirement |
| [BDD-003](../bbds/BDD-003_risk_limits.feature#scenario-2) | Validate portfolio heat threshold | Tests EARS STATE-001 | Acceptance test for requirement |
...
- **Position**: Project management layer between requirements (WHAT) and implementation (HOW)
...
```markdown
[REQ-003](../reqs/risk/lim/REQ-003_position_limit_enforcement.md#REQ-003)
[ADR-033](../adrs/ADR-033_risk_limit_enforcement_architecture.md#ADR-033)
...
[BDD-003](../bbds/BDD-003_risk_limits.feature#scenarios)
```
...
1. **ID Anchors** (Preferred): `#REQ-003`, `#ADR-033`, `#CTR-001`
   ...
   - Used in H1 headers: `# REQ-003: Position Limit Enforcement`, `# CTR-001: Position Risk Validation Contract`
...
- Examples:
  - From `reqs/risk/lim/` to `adrs/`: `../../../adrs/ADR-033_...md`
  - From `reqs/risk/lim/` to `contracts/`: `../../../contracts/CTR-001_...md`
  - From `prd/` to `ears/`: `../ears/EARS-001_...md`
  - From `specs/services/` to `reqs/`: `../../reqs/.../REQ-003_...md`
  - From `specs/services/` to `contracts/`: `../../contracts/CTR-001_...md`
...
|--------|--------|------------------|-------|
| BRD-001 Section 2.4 | PRD-001 Feature-003 | Business objective → Product feature | Risk management capability |
...
3. Copy IMPL-TEMPLATE.md from docs_templates/ai_dev_flow/impl_plans/
