...
**Position**: IMPL is in Layer 5 (Project Management Layer) - organizes WHO does WHAT, WHEN.
...
| **Version** | 1.0 |
| **Related REQs** | [REQ-NNN](../reqs/.../REQ-NNN.md), [REQ-MMM](../reqs/.../REQ-MMM.md) |
...
|----------------|-------------|------------------------|
| [REQ-NNN](../reqs/.../REQ-NNN.md) | [What business need] | [High-level approach in this IMPL] |
| [REQ-MMM](../reqs/.../REQ-MMM.md) | [Another requirement] | [How we'll address it] |
...
|------------|------|--------|-------------------|
| [REQ-NNN](../reqs/.../REQ-NNN.md) | Requirement | Approved | Cannot start Phase 1 |
| [ADR-MMM](../adrs/ADR-MMM.md) | Architecture Decision | Draft | Risk: Design changes |
...
|-------------|-------------|----------------|-------------------|--------------|
| REQ | [REQ-NNN](../reqs/.../REQ-NNN.md) | [Requirement Title] | Section X.Y | Business requirement |
| REQ | [REQ-MMM](../reqs/.../REQ-MMM.md) | [Another Requirement] | Section Z | Functional requirement |
| ADR | [ADR-PPP](../adrs/ADR-PPP.md) | [Architecture Decision] | All | Architecture guidance |
...
| SPEC | [SPEC-NNN](../specs/.../SPEC-NNN.yaml) | [Technical Spec] | Pending | Implementation blueprint |
| TASKS | [TASKS-NNN](../ai_tasks/TASKS-NNN.md) | [Code Generation Plan] | Pending | Code generation guide |
| CTR | [CTR-YY](../contracts/CTR-YY.md) | [API Contract] | Pending | Interface definition |
| SPEC | [SPEC-YY](../specs/.../SPEC-YY.yaml) | [Technical Spec] | Pending | Implementation blueprint |
| TASKS | [TASKS-YY](../ai_tasks/TASKS-YY.md) | [Code Generation Plan] | Pending | Code generation guide |
...
**Internal**: [REQ-NNN](../reqs/.../REQ-NNN.md) \| [ADR-PPP](../adrs/ADR-PPP.md) \| [IMPL-000 Index](./IMPL-000_index.md)

**Templates**: [CTR-TEMPLATE](../contracts/CTR-TEMPLATE.md) \| [SPEC-TEMPLATE](../specs/SPEC-TEMPLATE.yaml) \| [TASKS-TEMPLATE](../ai_tasks/TASKS-TEMPLATE.md)

**Guidelines**: [IMPL README](./README.md) \| [YAML Spec Standard](../specs/YAML_SPECIFICATION_STANDARD.md)
