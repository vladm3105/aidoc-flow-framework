...
- Data Storage, Broker Integration, Risk Calculation Engine
...
3. **BRD-trading-template.md** - Trading-specific requirements (options trading focus)
   - Specialized for financial trading systems
   - Includes trading-specific risk management
   - Options strategy and market data integration focus
...
- `BRD-009-02_broker_integration_pilot.md` - IB Gateway integration pilot
