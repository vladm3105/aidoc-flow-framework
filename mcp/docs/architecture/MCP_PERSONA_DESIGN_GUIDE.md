...
| --- | --- | --- |
| Persona and context contracts defined | Defined | `mcp/docs/specs/SPEC-002_*` |
| Runtime policy for project-specific-only loading | Defined | `mcp/docs/plans/IPLAN-001_*` |
| `mcp init` behavior in implementation plan | Implemented | `mcp/src/mcp_server/skills/scaffold.py`, `mcp/src/mcp_server/cli/main.py` |
| Context-engineering runtime implementation | Partial implementation present | `mcp/src/mcp_server/prompts/context_builder.py` |
| Project-specific UCX runtime loader | Partial implementation present | `mcp/src/mcp_server/skills/project_ucx_loader.py` |
| Review prompt build runner and artifact emission | Implemented | `mcp/src/mcp_server/review/runner.py`, `mcp/src/mcp_server/cli/main.py` |
