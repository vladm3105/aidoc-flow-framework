...
4. `mcp/src/mcp_server/remediation/*` (new)
5. `mcp/src/mcp_server/prescreening/*` (new)
6. `mcp/src/mcp_server/scoring/*` (new)
...
4. `mcp/tests/unit/test_prescreening.py` (new)
5. `mcp/tests/unit/test_scoring_cli.py` (new)
...
4. `mcp/docs/README.md`
5. `mcp/docs/ROADMAP.md`
