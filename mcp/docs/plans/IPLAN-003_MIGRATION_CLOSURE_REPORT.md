...
| --- | --- | --- |
| `pytest mcp/tests/unit/test_cli_main.py` | Passed (`7 passed`) | `mcp/tmp/iplan-003-evidence/pytest_test_cli_main.log` |
| `pytest mcp/tests/unit/test_validation_runner.py` | Passed (`2 passed`) | `mcp/tmp/iplan-003-evidence/pytest_test_validation_runner.log` |
| `pytest mcp/tests/unit/test_remediation_runner.py` | Passed (`4 passed`) | `mcp/tmp/iplan-003-evidence/pytest_test_remediation_runner.log` |
| `pytest mcp/tests/unit/test_prescreening.py` | Passed (`1 passed`) | `mcp/tmp/iplan-003-evidence/pytest_test_prescreening.log` |
| `pytest mcp/tests/unit/test_scoring_cli.py` | Passed (`2 passed`) | `mcp/tmp/iplan-003-evidence/pytest_test_scoring_cli.log` |
| `pytest mcp/tests/integration/test_migration_flows.py` | Passed (`1 passed`) | `mcp/tmp/iplan-003-evidence/pytest_test_migration_flows.log` |
...
- `mcp/docs/specs/SPEC-009_mcp_fix_flow_output_contracts.md`
- `mcp/docs/specs/SPEC-010_mcp_diagnostics_command_contracts.md`
