...
1. mcp/src/mcp_server/validation
2. mcp/src/mcp_server/creation/profile_contracts.py
3. mcp/tests/unit
4. mcp/tests/integration
...
2. mcp/src/mcp_server/reporting/contracts.py
3. mcp/src/mcp_server/core
4. mcp/tests/unit/test_cli_main.py
...
3. mcp/src/mcp_server/remediation
4. mcp/tests/unit
5. mcp/tests/integration
...
1. mcp/src/mcp_server/remediation/runner.py
2. mcp/src/mcp_server/reporting/contracts.py
3. mcp/tests/unit/test_remediation_runner.py
...
1. mcp/src/mcp_server/reporting
2. mcp/src/mcp_server/remediation
3. mcp/src/mcp_server/review
4. mcp/tests/unit
5. mcp/tests/integration
...
3. mcp/docs/architecture/MCP_RUNTIME_ARCHITECTURE.md
4. mcp/docs/architecture/MCP_OPERATOR_RUNBOOK.md
5. mcp/docs/specs/SPEC-003_mcp_creation_validation_profile_contracts.md
6. mcp/docs/specs/SPEC-004_mcp_reporting_lineage_artifact_contracts.md
7. mcp/docs/specs/SPEC-009_mcp_remediation_and_fix_flow_contracts.md
8. mcp/docs/specs/SPEC-010_mcp_prescreen_scan_scoring_contracts.md
...
1. Append a new dated entry to mcp/docs/CHANGELOG/CHANGELOG_v1.0.0.md after each completed phase.
...
1. Update mcp/docs/ROADMAP.md at phase boundaries.
...
4. Final closure report under mcp/docs/plans.
...
1. G1 checklist: mcp/docs/plans/CHECKLIST-005-G1_baseline_and_contracts.md
2. G2 checklist: mcp/docs/plans/CHECKLIST-005-G2_validation_and_consistency.md
3. G3 checklist: mcp/docs/plans/CHECKLIST-005-G3_diagnostics_and_safety.md
4. G4 checklist: mcp/docs/plans/CHECKLIST-005-G4_identity_and_release.md

### 11.2 Matrix Artifact

1. Gap closure matrix: mcp/docs/plans/GAP-CLOSURE-MATRIX-001_mcp_ucx_gap_closure.md
