...
- *Status:* SHIPPED (spec 0.32.4, 2026-06-30 — `BL-READY-SCORE-ADVISORY-PLAN.md`,
  ...
  14 score lines + one `_note:` per `health_score` block; PATCH 0.32.3 → 0.32.4. No
  rubric (author Q4). The "52 occurrences" was BeeLocal's per-artifact tally; the
  template fix is 14 field lines. IPLAN/08 carries neither field, so "all 7" = 01–07.
