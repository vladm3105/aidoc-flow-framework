...
> **Numbering note.** **D-0083** is not missing — it ships with PR **#595** (framework `0.48.0`
> / GD-23), which was still open when this entry was written. Both entries insert at the head of
> this file, so whichever lands second resolves a trivial conflict here.
