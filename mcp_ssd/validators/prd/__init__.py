...
class PRDValidationResult:
    ...
    def format_report(self, doc_id: str, doc_type: str = "PRD", version: int = 1) -> str:
        ...
        if self.has_errors:
            ...
            lines.append("- [ ] Run `ucx validate-fix prd <source-prd>` to create the `_validation` copy")
            lines.append("- [ ] Run `ucx review prd <source-prd>_validation.md` for AI review")
        return "\n".join(lines)
