...
| `BGF-03` | A bugfix IPLAN's `iplan_id` / `document_id` does not match its filename stem (§3.4.1 A1/A3 extended to the pattern). A mismatched ID breaks index and cross-link resolution. | error | `DOC_GOVERNANCE_CORE.md` §3.4.1 A1/A3 |
