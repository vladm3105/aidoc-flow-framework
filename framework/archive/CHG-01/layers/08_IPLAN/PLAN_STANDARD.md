...
| ------- | ---- | ------- |
| IPLAN | `IPLAN-NN_{slug}.yaml` | One SPEC component's file-creation order, executable steps, and session handoff. All IPLANs go through CHG. |
...
Neither artifact changes because this standard exists. A development plan
may *spawn* an IPLAN as one of its tasks, but the two are
