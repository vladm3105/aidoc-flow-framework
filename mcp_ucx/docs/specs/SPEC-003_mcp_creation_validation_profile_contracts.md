...
- Canonical registry source path for profile binding is `ucx_flow_v3/LAYER_REGISTRY.yaml`.
...
- mcp_ucx/docs/specs/SPEC-001_mcp_core_architecture_workflow_contracts.md
