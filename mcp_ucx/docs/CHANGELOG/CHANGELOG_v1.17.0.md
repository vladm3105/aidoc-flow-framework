...
**New file**: `mcp_ucx/src/mcp_server/env_manager.py`
...
| File | Change |
|------|--------|
| `mcp_ucx/src/mcp_server/env_manager.py` | **New** — env loading, caching, security |
| `mcp_ucx/src/mcp_server/executor/cli_runner.py` | Add `project_env` param, update env merge |
| `mcp_ucx/src/mcp_server/executor/dispatcher.py` | Add `project_env` param, forward to CLI runner |
| `mcp_ucx/src/mcp_server/tool_registry.py` | `sdd_env_show` tool def + dispatch, env load in `_maybe_run_executor` |
| `mcp_ucx/src/mcp_server/preflight/runner.py` | Enhanced `.env` check with key inventory |
| `mcp_ucx/src/mcp_server/cli/main.py` | `env-show` subcommand |
| `mcp_ucx/pyproject.toml` | Add `python-dotenv>=1.0.0` |
| `mcp_ucx/tests/unit/test_env_manager.py` | **New** — 12 unit tests |
| `mcp_ucx/tests/integration/test_executor_env.py` | **New** — 3 integration tests |
| `mcp_ucx/tests/unit/test_server.py` | Tool count 22→23 |
| `mcp_ucx/tests/unit/test_preflight_runner.py` | +2 env check tests |
