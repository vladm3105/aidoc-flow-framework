...
This roadmap defines planned documentation and governance milestones for MCP documentation under mcp_ucx/docs.
...
- `litellm` added as optional dependency (`pip install mcp_ucx[api]`)
...
- Added validation runner package under `mcp_ucx/src/mcp_server/validation/` with JSON/TXT report outputs.
...
- This roadmap covers documentation scope under mcp_ucx/docs.
