"""Structured logging for mcp_ucx operations.

Writes JSON-lines logs to {project_root}/UCX/logs/mcp_ucx.log.
...
_LOG_FILENAME = "mcp_ucx.log"
_configured_project_root: Path | None = None
_file_handler: logging.FileHandler | None = None

logger = logging.getLogger("mcp_ucx")
