...
mcp_sdd v1.8.0: All tools handle YAML documents on par with MD. Categorized scoring weights (structural vs cross-section errors). Result class API aliases for uniform access. YAML structure validation in remediation. Shared source file collector.

## Changes

### mcp_sdd Server (v1.8.0)
...
- [PLAN-018](mcp_sdd/docs/plans/PLAN-018_yaml_parity_and_api_consistency.md)
- [mcp_sdd CHANGELOG v1.8.0](mcp_sdd/docs/CHANGELOG/CHANGELOG_v1.8.0.md)
