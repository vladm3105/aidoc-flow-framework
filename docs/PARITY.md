...
> `claude-code-plugin/v0.10.2` (framework spec `0.15.0`; both platforms on the
...
(arriving with framework spec `0.15.0` via SAGA-PARITY-001, D-0031, which
...
| Layer Playbooks (BRD/PRD/EARS) | ✅ active | ⏳ deferred (HERMES-BACKLOG H-4) |
