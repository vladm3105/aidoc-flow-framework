...
> Status: as of project `v1.1.0` / `hermes/v0.11.1` /
> `claude-code-plugin/v0.23.4` (framework spec `0.40.0`; both platforms on the
...
default**, but since HERMES-REVIEW-LOOP-001 Phase 1 (`hermes/v0.11.1`,
