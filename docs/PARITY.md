...
> `claude-code-plugin/v0.15.0` (framework spec `0.18.0`; both platforms on the
...
(arriving with framework spec `0.18.0` via SAGA-PARITY-001, D-0031, which
