...
> `claude-code-plugin/v0.18.0` (framework spec `0.21.1`; both platforms on the
...
(arriving with framework spec `0.21.1` via SAGA-PARITY-001, D-0031, which
