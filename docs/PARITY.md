...
> `claude-code-plugin/v0.16.1` (framework spec `0.19.1`; both platforms on the
...
(arriving with framework spec `0.19.1` via SAGA-PARITY-001, D-0031, which
