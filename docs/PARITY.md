...
> `claude-code-plugin/v0.11.0` (framework spec `0.15.1`; both platforms on the
...
(arriving with framework spec `0.15.1` via SAGA-PARITY-001, D-0031, which
