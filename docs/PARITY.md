...
> `claude-code-plugin/v0.6.5` (framework spec `0.13.2`; both platforms on the
...
(arriving with framework spec `0.13.2` via SAGA-PARITY-001, D-0031, which
