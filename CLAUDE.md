...
**Current state (as of 2026-06-01):** framework spec `0.13.1`, Claude Code plugin `0.4.0` (pre-1.0 preview, 52 skills = 50 active + 2 deprecated stubs). IPLAN ↔ iplanic integration deferred — see `plans/IPLAN-IPLANIC-DEFERRED.md`.
