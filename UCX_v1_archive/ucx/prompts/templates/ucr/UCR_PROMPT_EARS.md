...
```markdown
---
title: "UCR Review Report: [EARS Document ID]"
tags:
  - ucr-review
  - ears-review
  - layer-3-artifact
...
custom_fields:
  ...
  source_artifact_type: EARS
  source_artifact_id: "[EARS-XX]"
  review_id: "[REVIEW_ID]"
  layer: 3
...
# UCR Review Report: [EARS Document ID]

## 0. Document Control

| Item | Details |
|------|---------|
| **Source Document** | [EARS-XX] (Version X.X) |
| **Review ID** | [REVIEW_ID] |
...
| Metric | Value |
|--------|-------|
| **Recommendation** | [✅ PROCEED / ⚠️ REMEDIATION REQUIRED / 🚨 SYNTAX REVISION REQUIRED] |
