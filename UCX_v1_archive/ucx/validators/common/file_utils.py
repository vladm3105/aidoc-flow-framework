...
# PLAN-012 naming conventions (underscore-based):
# - PRD-01_validation_report.md
# - PRD-01_platform_architecture_validation.md  (validation-fixed derived copy)
# - PRD-01_platform_architecture_remediated.md  (remediated derived copy)
...
COMPANION_REPORT_PATTERN = re.compile(
    ...
    r"(_v[0-9]+)?\.md$"
    r"|^\.precommit_validation_report\.md$"
    # PLAN-012: fixed-name validation report
    r"|_validation_report\.md$"
    # PLAN-012: derived copies (_validation, _remediated suffixes)
    r"|_validation\.md$"
    r"|_remediated\.md$"
    # PLAN-012: versioned review/remediation reports
    r"|_validation_review_report_v[0-9]+\.md$"
    r"|_validation_remediation_report_v[0-9]+\.md$"
    r")"
)
