...
| `/doc-brd-fixer` | UCRem | `UCRemPhase.generate_fixes(...)` | `ucx remediate <brd-path>` |
...
| `/doc-prd-fixer` | UCRem | `UCRemPhase.generate_fixes(...)` | `ucx remediate <prd-path>` |
...
| `/doc-ears-fixer` | UCRem | `UCRemPhase.generate_fixes(...)` | `ucx remediate <ears-path>` |
...
| `/doc-bdd-fixer` | UCRem | `UCRemPhase.generate_fixes(...)` | `ucx remediate <bdd-path>` |
...
| `/doc-adr-fixer` | UCRem | `UCRemPhase.generate_fixes(...)` | `ucx remediate <adr-path>` |
...
| `/doc-sys-fixer` | UCRem | `UCRemPhase.generate_fixes(...)` | `ucx remediate <sys-path>` |
...
| `/doc-req-fixer` | UCRem | `UCRemPhase.generate_fixes(...)` | `ucx remediate <req-path>` |
...
| `/doc-ctr-fixer` | UCRem | `UCRemPhase.generate_fixes(...)` | `ucx remediate <ctr-path>` |
...
| `/doc-spec-fixer` | UCRem | `UCRemPhase.generate_fixes(...)` | `ucx remediate <spec-path>` |
...
| `/doc-tspec-fixer` | UCRem | `UCRemPhase.generate_fixes(...)` | `ucx remediate <tspec-path>` |
...
# Remediation
ucx remediate docs/01_BRD/BRD-01.md --report docs/01_BRD/BRD_UCR_REVIEW.md
