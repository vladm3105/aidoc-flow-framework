"""Ingestion orchestrator for project_knowledge."""
...
from project_knowledge.graph.adapter import kb_extract
from project_knowledge.rag.adapter import kb_embed
from project_knowledge.utils import is_real_document
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run project_knowledge ingestion pipeline")
