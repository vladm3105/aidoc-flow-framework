"""Unified MCP server for project_knowledge tools."""
...
from project_knowledge.graph.adapter import (
    kb_extract,
    kb_extract_text,
    kb_graph_context,
    kb_graph_query,
...
from project_knowledge.rag.adapter import (
    kb_embed,
    kb_embed_text,
    kb_hybrid_context,
    kb_search,
...
TOOLS = [
    Tool(
        name="kb_embed",
        description="Embed a document into project_knowledge RAG",
        inputSchema={
            "type": "object",
            "properties": {
    ...
    Tool(
        name="kb_embed_text",
        description="Embed raw text into project_knowledge RAG",
        inputSchema={
            "type": "object",
            "properties": {
                "text": {"type": "string"},
    ...
    Tool(
        name="kb_search",
        description="Search project_knowledge RAG",
        inputSchema={
            "type": "object",
            "properties": {
                "query": {"type": "string"},
    ...
    Tool(
        name="kb_status",
        description="Get project_knowledge RAG status",
