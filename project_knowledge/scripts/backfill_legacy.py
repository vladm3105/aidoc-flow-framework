#!/usr/bin/env python3
"""Backfill legacy documents into project_knowledge using orchestrator."""
...
from project_knowledge.orchestrator import ingest_folder
...
def main() -> int:
    ...
    parser.add_argument("--out", default="project_knowledge/tmp/backfill_report.json")
