...
| File | Contains | Trigger Pattern |
|------|----------|-----------------|
| `/opt/data/ucx_framework/ucx_flow_v3/05_ADR/ADR-TEMPLATE.yaml` | `id: ADR-NN` | Any ADR doc_type |
| `/opt/data/ucx_framework/ucx_hermes/templates/ADR-TEMPLATE.yaml` | `id: ADR-NN` | Any ADR doc_type |
...
mv /opt/data/ucx_framework/ucx_flow_v3/05_ADR/ADR-TEMPLATE.yaml /tmp/
mv /opt/data/ucx_framework/ucx_hermes/templates/ADR-TEMPLATE.yaml /tmp/
...
mv /tmp/ADR-TEMPLATE.yaml /opt/data/ucx_framework/ucx_flow_v3/05_ADR/
