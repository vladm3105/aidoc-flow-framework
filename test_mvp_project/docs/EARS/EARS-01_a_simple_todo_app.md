---
title: "EARS-01: A Simple Todo App"
tags:
  - ears
  - mvp-template
  - layer-3-artifact
...
# EARS-01: [Target Component/Feature]
...
**EARS-01-01: [Requirement Name]**
```
WHEN [trigger condition]
THE [system component] SHALL [response action]
WITHIN [timing constraint] (@threshold: PRD.01.key)
```
**Traceability**: @prd: PRD.01.feature | @threshold: PRD.01.key

### 2.2 Unwanted Behavior (Error Handling)

**EARS-01-05: [Error Scenario]**
```
IF [error condition]
THE [system component] SHALL [recovery action]
```
**Traceability**: @prd: PRD.01.feature

### 2.3 State-Driven (While X then Y)

**EARS-01-10: [State Behavior]**
```
