...
python scripts/validate_traceability_matrix.py --matrix specs/TRACEABILITY_MATRIX_SPEC.md --input specs/

# Update incrementally
python scripts/update_traceability_matrix.py --matrix specs/TRACEABILITY_MATRIX_SPEC.md --input specs/

# Generate from scratch
python scripts/generate_traceability_matrix.py --type SPEC --input specs/ --output specs/TRACEABILITY_MATRIX_SPEC.md
```
