...
- **REQ** (`reqs/`): Formal requirements with functional/non-functional specifications
  ...
  - Examples:
    - [REQ-001](./reqs/api/av/REQ-001_alpha_vantage_integration.md) ([EXTERNAL_DATA_PROVIDER - e.g., Weather API, Stock Data API] Integration)
    - [REQ-002](./reqs/api/ib/REQ-002_ib_gateway_integration.md) ([EXTERNAL_SERVICE_GATEWAY] Integration)
    - [REQ-003](./reqs/risk/lim/REQ-003_position_limit_enforcement.md) ([RESOURCE_INSTANCE - e.g., database connection, workflow instance] Risk Limits)
...
- **IMPL** (`impl_plans/`): Implementation Plans organizing work into phases, teams, and deliverables
  ...
  - Example: [IMPL-001](./impl_plans/examples/IMPL-001_risk_management_system.md) ([RESOURCE_MANAGEMENT - e.g., capacity planning, quota management] System)
