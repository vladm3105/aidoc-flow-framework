...
- `docs/reqs/risk/` - Risk management requirements
- `docs/reqs/trading/` - Trade execution requirements
- `docs/reqs/portfolio/` - Portfolio management requirements
- `docs/reqs/compliance/` - Regulatory compliance requirements
- `docs/reqs/ml/` - ML model requirements (pricing, sentiment, regime detection)
...
**Requirements Subdirectories**:
- `docs/reqs/tenant/` - Multi-tenancy requirements
- `docs/reqs/subscription/` - Subscription management
- `docs/reqs/billing/` - Billing and invoicing
- `docs/reqs/workspace/` - Workspace features
...
**Requirements Subdirectories**:
- `docs/reqs/patient/` - Patient management
- `docs/reqs/clinical/` - Clinical workflows
- `docs/reqs/ehr/` - EMR/EHR features
- `docs/reqs/hipaa/` - HIPAA compliance
...
**Requirements Subdirectories**:
- `docs/reqs/catalog/` - Product catalog features
- `docs/reqs/cart/` - Shopping cart
- `docs/reqs/order/` - Order management
- `docs/reqs/payment/` - Payment processing
- `docs/reqs/inventory/` - Inventory management
...
**Requirements Subdirectories**:
- `docs/reqs/device/` - Device management
- `docs/reqs/telemetry/` - Data collection
- `docs/reqs/firmware/` - OTA updates
- `docs/reqs/edge/` - Edge computing
...
✓ Created: docs/reqs/tenant/
✓ Created: docs/reqs/subscription/
✓ Created: docs/reqs/billing/
✓ Created: docs/reqs/workspace/
