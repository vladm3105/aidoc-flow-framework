...
- REQ: `reqs/risk/lim/REQ-003_position_limit_enforcement.md` (H1: `# REQ-003: [RESOURCE_LIMIT - e.g., request quota, concurrent sessions] Enforcement`)
...
- IMPL: `impl_plans/IMPL-001_risk_management_system.md` (H1: `# IMPL-001: [RESOURCE_MANAGEMENT - e.g., capacity planning, quota management] System Implementation`)
- TASKS: `ai_tasks/TASKS-003_position_limit_service.md` (H1: `# TASKS-003: [RESOURCE_LIMIT - e.g., request quota, concurrent sessions] Service Implementation`)
...
@requirement:[REQ-009-01](../reqs/[EXTERNAL_INTEGRATION - e.g., third-party API, service provider]/ib/REQ-009-01_prerequisites.md#REQ-009-01)
