...
python scripts/validate_traceability_matrix.py --matrix reqs/TRACEABILITY_MATRIX_REQ.md --input reqs/

# Update incrementally
python scripts/update_traceability_matrix.py --matrix reqs/TRACEABILITY_MATRIX_REQ.md --input reqs/

# Generate from scratch
python scripts/generate_traceability_matrix.py --type REQ --input reqs/ --output reqs/TRACEABILITY_MATRIX_REQ.md
```
