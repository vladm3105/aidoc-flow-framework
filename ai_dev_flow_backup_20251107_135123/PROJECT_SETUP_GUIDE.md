...
mkdir -p docs/brds docs/prd docs/ears docs/bbds docs/adrs docs/sys docs/reqs docs/impl_plans docs/contracts docs/specs docs/ai_tasks

# Standard requirements subdirectories (ALL PROJECTS)
mkdir -p docs/reqs/api docs/reqs/auth docs/reqs/data docs/reqs/core docs/reqs/integration docs/reqs/monitoring docs/reqs/reporting docs/reqs/security docs/reqs/ui

# Domain-specific subdirectories (based on Step 1 selection)
# Financial Services:
mkdir -p docs/reqs/risk docs/reqs/trading docs/reqs/portfolio docs/reqs/compliance docs/reqs/ml

# Software/SaaS:
mkdir -p docs/reqs/tenant docs/reqs/subscription docs/reqs/billing docs/reqs/workspace
...
ls -la docs/reqs/  # Verify subdirectories
```
...
✓ Created: docs/sys/
✓ Created: docs/reqs/
✓ Created: docs/impl_plans/
✓ Created: docs/contracts/
✓ Created: docs/specs/
✓ Created: docs/ai_tasks/

✓ Created: docs/reqs/api/
✓ Created: docs/reqs/auth/
✓ Created: docs/reqs/data/
✓ Created: docs/reqs/risk/
✓ Created: docs/reqs/trading/
✓ Created: docs/reqs/portfolio/
✓ Created: docs/reqs/compliance/
✓ Created: docs/reqs/ml/
...
mkdir -p docs/{brds,prd,ears,bbds,adrs,sys,reqs,impl_plans,contracts,specs,ai_tasks}
mkdir -p docs/reqs/{api,auth,data,core,integration,monitoring,reporting,security,ui}
...
for type in brds prd ears bbds adrs sys reqs impl_plans contracts specs ai_tasks; do
