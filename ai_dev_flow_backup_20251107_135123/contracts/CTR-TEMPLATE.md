...
### Example 2: Validation Failure - [RESOURCE_LIMIT - e.g., request quota, concurrent sessions] Exceeded
**Request**:
```json
{
  "[RESOURCE_INSTANCE - e.g., database connection, workflow instance]": {
...
|-------------|-------------|----------------|-------------------|--------------|
| REQ | [REQ-003](../reqs/risk/lim/REQ-003_position_limit_enforcement.md) | [RESOURCE_LIMIT - e.g., request quota, concurrent sessions] Enforcement | Section 3.1 | Defines validation requirements |
...
| SPEC | [SPEC-001](../specs/agents/SPEC-001_portfolio_orchestrator.yaml) | [ORCHESTRATION_COMPONENT] | Primary consumer |
...
### Internal Links
- [REQ-003: [RESOURCE_LIMIT - e.g., request quota, concurrent sessions] Enforcement](../reqs/risk/lim/REQ-003_position_limit_enforcement.md)
