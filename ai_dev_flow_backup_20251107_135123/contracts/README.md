...
|-------------|-------------|----------------|-------------------|--------------|
| REQ | [REQ-003](../reqs/.../REQ-003.md) | [RESOURCE_LIMIT - e.g., request quota, concurrent sessions] Enforcement | Section 3.1 | Interface requirement |
...
This service implements **[CTR-001: [RESOURCE_INSTANCE - e.g., database connection, workflow instance] Risk Validation](../contracts/CTR-001_position_risk_validation.md)** as the provider.
