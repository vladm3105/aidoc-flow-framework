...
```bash
mkdir -p docs/reqs/tenant/           # Multi-tenancy requirements
mkdir -p docs/reqs/tenant/isolation/ # Data isolation
mkdir -p docs/reqs/tenant/onboard/   # Tenant onboarding

mkdir -p docs/reqs/subscription/     # Subscription management
mkdir -p docs/reqs/subscription/plan/    # Plan management
mkdir -p docs/reqs/subscription/billing/ # Billing & invoicing

mkdir -p docs/reqs/billing/          # Billing engine
mkdir -p docs/reqs/billing/metered/  # Usage-based billing
mkdir -p docs/reqs/billing/invoice/  # Invoice generation

mkdir -p docs/reqs/workspace/        # Workspace features
mkdir -p docs/reqs/workspace/collab/ # Collaboration tools
mkdir -p docs/reqs/workspace/perm/   # Permissions
```
...
- [ ] `docs/reqs/tenant/` directory exists
- [ ] `docs/reqs/subscription/` directory exists
- [ ] `docs/reqs/billing/` directory exists
- [ ] `docs/reqs/workspace/` directory exists
