...
**[RESOURCE_INSTANCE - e.g., database connection, workflow instance]**: EARS is in Layer 1 (Business Layer) - transforms PRD into formal WHEN/THEN requirements.
...
|-------------------|----------------------|------------------|--------------|---------------|
| Event-001 | [EXTERNAL_DATA - e.g., customer data, sensor readings] processing latency | [BDD-NNN.feature](../bbds/BDD-NNN.feature#L10) | Scenario: Process [EXTERNAL_DATA - e.g., customer data, sensor readings] within latency target | Unit + Integration |
...
| Ubiquitous-001 | Data normalization | [BDD-NNN.feature](../bbds/BDD-NNN.feature#L55) | Scenario: Normalize [EXTERNAL_DATA_PROVIDER - e.g., Weather API, Stock Data API] to IB schema | Unit |
