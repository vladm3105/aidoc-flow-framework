...
├── bbds/          # Behavior-Driven Development (Gherkin)
...
mkdir -p docs/reqs/{risk,trading,portfolio,compliance,ml}

# Domain-specific (Software/SaaS)
mkdir -p docs/reqs/{tenant,subscription,billing,workspace}
```
...
|--------|------|-----------|
| [BRD-001](../brds/BRD-001_business.md#BRD-001) | Business Requirements | Context |
| [PRD-002](../prd/PRD-002_product.md#PRD-002) | Product Requirements | Feature spec |

### Downstream Artifacts
| Artifact | Type | Reference |
|----------|------|-----------|
| [SPEC-023](../specs/SPEC-023_impl.yaml#SPEC-023) | Technical Specification | Implementation |
| [TASKS-023](../ai_tasks/TASKS-023_impl.md#TASKS-023) | Implementation Tasks | TODOs |
...
| **SPEC** | Technical specs | .yaml | SPEC-010_limiter.yaml |
