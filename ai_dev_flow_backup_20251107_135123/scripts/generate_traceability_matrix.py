...
Examples:
  ...
  python generate_traceability_matrix.py --type REQ --input ../reqs/api/ --output api_matrix.md

  # Generate SPEC matrix
  python generate_traceability_matrix.py --type SPEC --input ../specs/ --output TRACEABILITY_MATRIX_SPEC.md
        """
    )
