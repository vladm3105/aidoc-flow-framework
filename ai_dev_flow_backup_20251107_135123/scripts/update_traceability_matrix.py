...
Examples:
  ...
  python update_traceability_matrix.py --matrix matrix.md --input ../specs/ --dry-run

  # Update and save changelog
  python update_traceability_matrix.py --matrix matrix.md --input ../reqs/ --changelog changelog.md
        """
    )
