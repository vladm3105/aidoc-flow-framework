...
```bash
# For ADRs
python scripts/generate_traceability_matrix.py --type ADR --input docs/adrs/ --output docs/TRACEABILITY_MATRIX_ADR.md

# For Requirements
python scripts/generate_traceability_matrix.py --type REQ --input docs/reqs/ --output docs/TRACEABILITY_MATRIX_REQ.md

# For Specifications
python scripts/generate_traceability_matrix.py --type SPEC --input docs/specs/ --output docs/TRACEABILITY_MATRIX_SPEC.md
```
...
```bash
# Validate ADR matrix
python scripts/validate_traceability_matrix.py --matrix docs/TRACEABILITY_MATRIX_ADR.md --input docs/adrs/

# Validate REQ matrix
python scripts/validate_traceability_matrix.py --matrix docs/TRACEABILITY_MATRIX_REQ.md --input docs/reqs/
```
...
def end_of_day_validation():
    ...
    print(f"  ADRs: {count_documents('adrs')}")
    print(f"  REQs: {count_documents('reqs')}")
    print(f"  SPECs: {count_documents('specs')}")
...
4. Example fix: `[REQ-003](../reqs/risk/REQ-003_position_limit.md#REQ-003)`
