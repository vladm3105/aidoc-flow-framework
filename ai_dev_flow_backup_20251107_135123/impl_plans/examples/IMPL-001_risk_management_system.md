...
- [REQ-003: [RESOURCE_LIMIT - e.g., request quota, concurrent sessions] Enforcement](../../reqs/REQ-003.md)
- [REQ-005: [RESOURCE_COLLECTION - e.g., user accounts, active sessions] Risk Aggregation](../../reqs/REQ-005.md)
- [REQ-008: [SAFETY_MECHANISM - e.g., rate limiter, error threshold] System](../../reqs/REQ-008.md)
