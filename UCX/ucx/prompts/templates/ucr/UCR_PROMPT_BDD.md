...
```markdown
---
title: "UCR Review Report: [BDD Document ID]"
tags:
  - ucr-review
  - bdd-review
  - layer-4-artifact
...
custom_fields:
  ...
  source_artifact_type: BDD
  source_artifact_id: "[BDD-XX]"
  review_id: "[REVIEW_ID]"
  layer: 4
...
# UCR Review Report: [BDD Document ID]

## 0. Document Control

| Item | Details |
|------|---------|
| **Source Document** | [BDD-XX] (Version X.X) |
| **Review ID** | [REVIEW_ID] |
...
| Metric | Value |
|--------|-------|
| **Recommendation** | [✅ PROCEED / ⚠️ REMEDIATION REQUIRED / 🚨 SCENARIOS INCOMPLETE] |
