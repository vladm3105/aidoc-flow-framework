...
python scripts/validate_cross_document.py --document docs/10_SPEC/SPEC-NN_slug/SPEC-NN_slug.yaml --auto-fix
...
|------------|------------------------|-----------|
| SPEC (Layer 10) | @brd through @req (+ optional @impl, @ctr) | 7-9 |
