...
python scripts/generate_traceability_matrix.py --type SPEC --output docs/10_SPEC/SPEC-00_TRACEABILITY_MATRIX.md
```
...
- **Related Matrices**: [REQ](../07_REQ/REQ-00_TRACEABILITY_MATRIX-TEMPLATE.md), [CTR](../09_CTR/CTR-00_TRACEABILITY_MATRIX-TEMPLATE.md), [TASKS](../11_TASKS/TASKS-00_TRACEABILITY_MATRIX-TEMPLATE.md)
