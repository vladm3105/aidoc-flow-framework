...
|--------------|-------------|----------------|---------|
| Related | [IPLAN-01](./IPLAN-01_...md) | [Related IPLAN title] | Shared session context |
| Depends | [IPLAN-01](./IPLAN-01_...md) | [Prerequisite IPLAN title] | Must complete before this |

**Tags:**<!-- VALIDATOR:IGNORE-LINKS-END -->

```markdown
@related-iplan: IPLAN-01
@depends-iplan: IPLAN-01
```
...
**Direct Parent**:
- [TASKS-NN](../11_TASKS/[path]/TASKS-NN.md) - Code generation plan being implemented

**Technical Specifications**:
- [SPEC-NN](../10_SPEC/[path]/SPEC-NN.yaml) - Technical blueprint for implementation

**Requirements**:
- [REQ-NN](../07_REQ/[path]/REQ-NN.md) - Atomic requirements satisfied
- [REQ-NN](../07_REQ/[path]/REQ-NN.md) - Additional requirements

**Architecture Decisions**:
- [ADR-NN](../05_ADR/ADR-NN.md) - Architecture decisions guiding implementation
- [ADR-NN](../05_ADR/ADR-NN.md) - Technology/pattern choices
...
- [PRD-NN](../02_PRD/[path]/PRD-NN.md) - Product requirements driving feature

**Business Requirements**:
- [BRD-NN](../01_BRD/[path]/BRD-NN.md) - Business needs and objectives

**Optional (if present)**:
- [IMPL-NN](../08_IMPL/[path]/IMPL-NN.md) - Implementation strategies
- [CTR-NN](../09_CTR/[path]/CTR-NN.md) - Interface contracts to implement
...
**Sibling Documents**:
- [IPLAN-01](./IPLAN-01.md) - Related implementation plans
...
- [TASKS-TEMPLATE.md](../11_TASKS/TASKS-TEMPLATE.md) - Parent artifact template
- [SPEC-TEMPLATE.yaml](../10_SPEC/SPEC-TEMPLATE.yaml) - Technical specification template
- [BDD-TEMPLATE.feature](../04_BDD/BDD-TEMPLATE.feature) - BDD scenario template

### 12.3 Related Artifacts
<!-- VALIDATOR:IGNORE-LINKS-START -->
- [TASKS-NN](../11_TASKS/[path]/TASKS-NN.md) - Parent code generation plan
<!-- VALIDATOR:IGNORE-LINKS-END -->
<!-- VALIDATOR:IGNORE-LINKS-START -->
- [SPEC-NN](../10_SPEC/[path]/SPEC-NN.yaml) - Technical specification
<!-- VALIDATOR:IGNORE-LINKS-END -->
<!-- VALIDATOR:IGNORE-LINKS-START -->
- [REQ-NN](../07_REQ/[path]/REQ-NN.md) - Requirements being implemented
<!-- VALIDATOR:IGNORE-LINKS-END -->
...
- Keep links to 11_TASKS/07_REQ/SPEC in sync; update any indexes
