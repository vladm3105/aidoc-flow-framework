...
python3 scripts/validate_tags_against_docs.py \
  --file 12_IPLAN/IPLAN-01_example.md
...
Per [TASKS.01.29.01](../11_TASKS/path/TASKS-01.md#phase-21-implement-connection-service):
...
Per [SPEC-01:error_handling](../10_SPEC/SPEC-01_{slug}/SPEC-01_{slug}.yaml):
...
- See [SPEC-01:models](../10_SPEC/SPEC-01_{slug}/SPEC-01_{slug}.yaml) for field specifications
```
...
@req: REQ.01.26.01 (verified: /opt/data/project/docs/07_REQ/REQ-01.md exists)
```
...
cat /opt/data/project/docs/11_TASKS/TASKS-01.md | grep "@req"
...
**Usage**:
```bash
python validate_tags_against_docs.py --file 12_IPLAN/IPLAN-01.md
...
- Update any roll-up indexes and cross-links to 11_TASKS/REQs
