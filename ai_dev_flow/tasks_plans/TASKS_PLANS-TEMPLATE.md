# Implementation Plan - TASKS_PLANS-NNN: [Descriptive Task/Feature Name]
...
- **tasks_plans**: Implementation work plans (HOW to execute with specific commands)
...
All tasks_plans documents MUST include these cumulative tags from upstream artifacts:
...
3. **Bidirectional Links**: Tagged documents MUST reference this tasks_plans document in their downstream traceability
4. **Format Compliance**: Tags MUST follow `@type: DOC-ID:REQ-ID` pattern
5. **Layer Hierarchy**: Tags MUST respect the 15-layer cumulative tagging hierarchy
...
- **Traceability Matrix**: Update `TASKS_PLANS-000_TRACEABILITY_MATRIX-TEMPLATE.md`
...
- [CTR-NNN](../CONTRACTS/[path]/CTR-NNN.md) - Interface contracts to implement
...
**Sibling Documents**:
- [TASKS_PLANS-NNN](./TASKS_PLANS-NNN.md) - Related implementation plans
- [TASKS_PLANS-000_index.md](./TASKS_PLANS-000_index.md) - Index of all implementation plans
