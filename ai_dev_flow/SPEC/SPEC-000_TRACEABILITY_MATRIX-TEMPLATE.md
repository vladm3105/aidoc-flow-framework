...
Note: Example commands below use a portable `docs/` root. In this repository, artifact folders live at the ai_dev_flow root without the `docs/` prefix; see README → “Using This Repo” for path mapping.
...
python scripts/generate_traceability_matrix.py --type SPEC --output docs/SPEC/SPEC-000_TRACEABILITY_MATRIX.md
```
