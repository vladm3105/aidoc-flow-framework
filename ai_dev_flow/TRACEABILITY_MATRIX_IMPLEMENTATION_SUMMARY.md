...
#### 1. ADR/examples/TRACEABILITY_MATRIX_ADR_EXAMPLE.md
...
#### 2. REQ/examples/TRACEABILITY_MATRIX_REQ_EXAMPLE.md
...
#### 3. SPEC/examples/TRACEABILITY_MATRIX_SPEC_EXAMPLE.md
...
- Gap analysis for in-development and planned SPEC
...
```bash
# 1. Create ADR documents in ADR/ directory
...
python scripts/generate_traceability_matrix.py \
  --type ADR \
  --input ADR/ \
  --output ADR/TRACEABILITY_MATRIX_ADR.md
...
python scripts/update_traceability_matrix.py \
  --matrix ADR/TRACEABILITY_MATRIX_ADR.md \
  --input ADR/ \
  --changelog ADR/matrix_update_log.md
