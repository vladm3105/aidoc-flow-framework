...
## IMPL vs IPLAN: Critical Distinction
...
❌ **Integration patterns** (that's 05_ADR/SPEC)
...
| **Deliverables** | List of 09_CTR/10_SPEC/TASKS to create | Source code files |
...
- **Deliverables Checklist**: All 09_CTR/10_SPEC/TASKS to create
...
**Note**: IMPL Plans do NOT directly produce code. They organize the creation of technical documents (09_CTR/10_SPEC/TASKS) which eventually lead to code.
...
├── IMPL_IMPLEMENTATION_PLAN.md        # Example: Plan for creating 08_IMPL/ system
...
- [ ] **Deliverables Listed**: All 09_CTR/10_SPEC/TASKS enumerated
- [ ] **Risks Assessed**: Project risks identified with mitigations
- [ ] **Traceability Complete**: Links to 07_REQ/05_ADR/SYS
...
3. **Identify Deliverables**: List all 09_CTR/10_SPEC/TASKS needed
...
- **Track Deliverables**: Link to created 09_CTR/10_SPEC/TASKS
...
**Problem**: Phase says "Build resource management" but doesn't list which 09_CTR/10_SPEC/TASKS
...
```bash
cp ai_dev_flow/08_IMPL/IMPL-TEMPLATE.md \
   docs/08_IMPL/IMPL-NN_my_feature.md
```
...
- **Deliverables**: All 09_CTR/10_SPEC/TASKS enumerated?
...
- **IMPL-00_index.md**: Master index of all IMPL plans
- **IMPL-TEMPLATE.md**: Template for new IMPL plans
- **TASKS README**: Understanding code generation plans (11_TASKS/README.md)
...
| What goes in IMPL? | Phases, teams, timeline, deliverables (09_CTR/10_SPEC/TASKS) |
