...
- [REQ-TEMPLATE.md](../07_REQ/REQ-TEMPLATE.md): Requirements template (BDD validates requirements)
- [SPEC-TEMPLATE.yaml](../10_SPEC/SPEC-TEMPLATE.yaml): Technical SPEC template (implements BDD scenarios)
