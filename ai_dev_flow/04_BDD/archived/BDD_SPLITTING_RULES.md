...
- Unify BDD naming with 02_PRD/BRD section-based standards
- Keep feature files executable and maintainable (≤500 lines, ≤12 scenarios)
- Enforce nested suite structure under docs/04_BDD/BDD-NN_{slug}/
...
- [ ] All `.feature` files live inside suite folder: docs/04_BDD/BDD-NN_{slug}/
