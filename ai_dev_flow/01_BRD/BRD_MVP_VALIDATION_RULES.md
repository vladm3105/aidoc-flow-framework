...
**Valid Link Format**:
```markdown
[PRD-01 Product Requirements](../02_PRD/PRD-01_product_requirements.md)
...
2. Referenced BRD files must exist in `docs/01_BRD/` directory
...
2. Verify each referenced BRD file exists: `docs/01_BRD/BRD-NN_*.md`
