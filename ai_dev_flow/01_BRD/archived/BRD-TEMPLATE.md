...
> Use nested folder structure: `docs/01_BRD/BRD-NN/BRD-NN.S_slug.md`
...
- **[PRD Template - Stakeholders & Communication section](../02_PRD/PRD-TEMPLATE.md#stakeholders--communication)** - Full stakeholder matrix and engagement strategy
...
- **[PRD Template - User Stories & User Roles section](../02_PRD/PRD-TEMPLATE.md#user-stories--user-roles)** - Full user story tables and role definitions
...
- **[PRD Template - User Roles and Permissions section](../02_PRD/PRD-TEMPLATE.md#user-roles-and-permissions)** - Full role definitions with permissions matrix
...
- **[EARS Template - section 5.6: Business vs Technical Requirements Boundary](../03_EARS/EARS-TEMPLATE.md#56-business-vs-technical-requirements-boundary)** - Full guidance for requirements writers
- **[BDD Template - Header: Quick Self-Check Questions](../04_BDD/BDD-TEMPLATE.feature)** - Fast validation checklist
...
- **[PRD Template - Customer-Facing Content & Messaging section](../02_PRD/PRD-TEMPLATE.md#customer-facing-content--messaging)** - Product-level messaging templates and examples
