...
- [ ] **Traceability Complete**: All upstream 07_REQ/ADR referenced, downstream SPEC linked
...
|---------------|-------------|----------------|--------------|
| SPEC | [SPEC-05](../10_SPEC/.../SPEC-05.yaml) | Risk Validation Service | Provider implementation |
...
```markdown
# In markdown files
[CTR-01](../09_CTR/CTR-01_data_validation.md#CTR-01)
[CTR-01 Schema](../09_CTR/CTR-01_data_validation.yaml)

# If using subdirectories
[CTR-01](../09_CTR/agents/CTR-01_service_orchestrator_api.md)
```
...
This service implements **[CTR-01: resource Risk Validation](../09_CTR/CTR-01_data_validation.md)** as the provider.
...
```python
# tests/09_CTR/risk_validation/test_provider_contract.py
import pact
...
```python
# tests/09_CTR/risk_validation/test_consumer_contract.py
import pact
...
yamllint 09_CTR/CTR-01_data_validation.yaml

# JSON Schema validator - Schema structure validation
check-jsonschema --schemafile 09_CTR/CTR-01_data_validation.yaml
```

### 13.2 OpenAPI Linters
```bash
# Spectral - OpenAPI/AsyncAPI linter
spectral lint 09_CTR/CTR-01_data_validation.yaml
```
...
| **Link traceability** | 07_REQ/ADR (upstream), 10_SPEC/Code (downstream) |
