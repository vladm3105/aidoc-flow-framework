...
- Organize by category subtree: `REQ/api/`, `REQ/risk/`, `REQ/ml/`, `REQ/data/`, etc.
...
- `risk/`: [RESOURCE_MANAGEMENT - e.g., capacity planning, quota management] and validation requirements
