---
title: "REQ Template V2 - ARCHIVED"
tags:
  - archived
  - deprecated
  - layer-7-artifact
...
| **Verification Method** | 04_BDD/Spec/Unit Test/Integration Test/Contract Test |
...
- **Specification Compliance**: [SPEC-NN](../../10_SPEC/.../SPEC-NN.yaml)
...
|--------|-----------|------------------------------|-----------------|
| [ADR-NN](../05_ADR/ADR-NN_...md#ADR-NN) | [Architecture decision title] | Technology selection, patterns | Architectural implementation |

#### Technical Specifications

| SPEC ID | Specification Title | Requirement Aspects Implemented | Implementation Path |
|---------|-------------------|--------------------------------|---------------------|
| [SPEC-NN](../../10_SPEC/.../SPEC-NN.yaml) | [Technical spec title] | Interfaces, schemas, error handling, config | src/[module]/[component].py |
...
|--------|----------------|-------------------|--------------|
| [CTR-NN](../../09_CTR/CTR-NN.md) | [API Contract Title] | REST API / Event Schema | Interface specification |
