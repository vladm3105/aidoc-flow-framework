...
**Quick Reference**:
```
... → SYS → **REQ** → IMPL → 09_CTR/SPEC → TASKS → Code → ...
                ↑
        Requirements Layer
...
| **Verification Method** | 04_BDD/Spec/Unit Test/Integration Test |
...
- **Specification Compliance**: [SPEC-NN](../../10_SPEC/.../SPEC-NN.yaml) - [How the specification implements this requirement]
...
|-------------|-------------|----------------|-------------------|--------------|
| BRD | [BRD-NN](../../01_BRD/BRD-NN_...md) | [Business requirements title] | sections 2.4, 4.x | Business objectives justifying this requirement |
| PRD | [PRD-NN](../../02_PRD/PRD-NN_...md) | [Product requirements title] | Functional Requirements 4.x | Product features this requirement enables |
| SYS | [SYS-NN](../../06_SYS/SYS-NN_...md) | [System requirements title] | System Requirements 3.x | System-level specification this implements |
| EARS | [EARS-NN](../../03_EARS/EARS-NN_...md) | [Engineering requirements] | Event-driven/State-driven statements | Formal engineering requirement this satisfies |
...
|--------|-----------|------------------------------|-----------------|--------------|
| [ADR-NN](../05_ADR/ADR-NN_...md#ADR-NN) | [Architecture decision title] | [How ADR implements this requirement] | Technology selection, patterns | Architectural implementation |
| [ADR-MM](../05_ADR/ADR-MM_...md) | [Another decision] | [Alternative approaches or complementary decisions] | Integration patterns | System integration approach |
...
|---------|-------------------|--------------------------------|---------------------|--------------|
| [SPEC-NN](../../10_SPEC/.../SPEC-NN.yaml) | [Technical spec title] | [Specific functionality defined] | src/[module]/[component].py | Implementation blueprint |
| [SPEC-MM](../../10_SPEC/.../SPEC-MM.yaml) | [Interface spec] | [API/contract definition] | src/[module]/interfaces/ | Interface specification |
...
|--------|----------------|-------------------|--------------|
| [CTR-NN](../../09_CTR/CTR-NN.md) | [API Contract Title] | [REST API / Event Schema / Data Model] | Interface specification |
...
|---------|-----------|--------------------------------|----------------------|--------------|
| [TASKS-NN](../../11_TASKS/TASKS-NN_....md) | [Implementation plan] | [Specific functionality to build] | Pending/In Progress/Complete | AI-assisted development plan |
