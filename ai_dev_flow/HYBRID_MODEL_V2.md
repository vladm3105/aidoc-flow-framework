---
title: "Hybrid Development Model v2.1"
tags:
  - framework-guide
  - shared-architecture
  - project-management
...
| GitHub Project (V2) | Sprint board, phase tracking | `GITHUB_PROJECT_SETUP.md` |
...
|----------|--------|-------------------|
| BRD-00_index.md | Required | Create using `/doc-brd` |
| ADR folder structure | Required | Create `docs/05_ADR/` |
| TASKS template | Required | Copy from `ai_dev_flow/11_TASKS/` |
| CHG template | Required | Copy from `ai_dev_flow/CHG/` |
...
**Source Reference**: `/opt/data/techtrend/AI-cost-monitoring/governance/`
...
**Source Reference**: `/opt/data/docs_flow_framework/ai_dev_flow/`
...
## 4. Hybrid Model v2.1 Architecture
...
**Reference**: `ai_dev_flow/CHG/CHANGE_MANAGEMENT_GUIDE.md`
...
| Governance Rules | `governance/GOVERNANCE_RULES.md` | Sprint governance policies |
| Project Plan | `governance/PROJECT_PLAN.md` | Phase and task breakdown |
| Definition of Done | `governance/DEFINITION_OF_DONE.md` | Completion criteria |
...
| Aspect | Sprint-Based | Document Flow | Hybrid v2.1 |
|--------|--------------|---------------|-------------|
| **Focus** | Task execution | Traceability | Both |
| **Structure** | 8 phases, sprints | 15 layers | Tiers 1-3 + Sprints |
| **Automation** | 43% time reduction | 90% artifact generation | Combined |
| **Traceability** | Issue→PR→Code | BRD→Code (full) | Full with automation |
| **Human Touchpoints** | Every sprint | 5 checkpoints | Sprint + checkpoints |
| **Quality Gates** | DoD checklists | 14+ validators | Integrated in CI |
| **Feedback Loop** | Retrospective | CHG documents | Both + automation |
| **Best For** | Small teams, POCs | Regulated, complex | Production products |
