...
- Machine-readable, supports validation tooling
- Consistent with unified YAML template pattern
- Direct integration with `sdd_validate` MCP tool
...
| ID | Feature/Suite | Sourced From | Status | MCP Validated | Last Updated |
|----|---------------|--------------|--------|---------------|--------------|
| [BDD-TEMPLATE.yaml](./BDD-TEMPLATE.yaml) | Template (default) | - | Reference | - | 2026-03-29 |
...
### API Integrations
*[BDD scenarios for external service integrations]*

### Resource Management
*[BDD scenarios for risk validation and controls]*

### ML Models
*[BDD scenarios for machine learning model validation]*

### Service Strategies
*[BDD scenarios for service strategy execution]*

### Data Architecture
*[BDD scenarios for data management and analytics]*

### System Services
*[BDD scenarios for system-level services]*
...
1. **Generate via MCP**: `sdd_create doc_type=bdd layer=04_BDD`
...
5. **Update this index**: Add entry to the document registry and appropriate functional area section
...
- [ ] MCP validation complete: `sdd_score_validate` confirms BDD-Ready >=90/100
