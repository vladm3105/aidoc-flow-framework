...
**Root Cause Layer**: L{N} - {Layer Name} (v3.2: L1=BRD, L2=PRD, L3=EARS, L4=BDD, L5=ADR, L6=SPEC, L7=TDD, L8=IPLAN, Code)
...
| Document | Link |
|----------|------|
| CHG Document | CHG-EMG-{timestamp}.yaml |
| Incident Ticket | INC-XXX |
| Hotfix PR | PR-XXX |
