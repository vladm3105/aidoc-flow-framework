...
| --- | --- | --- |
| Persona and context contracts defined | Implemented | `mcp_ucx/docs/specs/SPEC-002_*` |
| Runtime policy for project-specific-only loading | Implemented | `mcp_ucx/src/mcp_server/skills/project_ucx_loader.py` |
| `mcp init` scaffold with no-overwrite semantics | Implemented | `mcp_ucx/src/mcp_server/skills/scaffold.py` |
| `ProjectSkillsNotFound` error contract | Implemented | `mcp_ucx/src/mcp_server/skills/project_ucx_loader.py` |
| Context-engineering runtime (prompt assembly) | Implemented | `mcp_ucx/src/mcp_server/prompts/context_builder.py` |
| Project-specific UCX runtime loader | Implemented | `mcp_ucx/src/mcp_server/skills/project_ucx_loader.py` |
| Review prompt build runner and artifact emission | Implemented | `mcp_ucx/src/mcp_server/review/runner.py` |
| Creation prompt assembly and layer asset loading | Implemented | `mcp_ucx/src/mcp_server/prompts/context_builder.py` |
| Sidecar metadata and inspection diagnostics | Implemented | `mcp_ucx/src/mcp_server/prompts/context_builder.py` |
| Scaffold mapping for all 6 asset categories | Implemented | `mcp_ucx/src/mcp_server/skills/scaffold.py` |
