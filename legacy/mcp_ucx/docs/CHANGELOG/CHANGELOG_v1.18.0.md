...
**New file**: `mcp_ucx/src/mcp_server/project_context.py`
...
| File | Change |
|------|--------|
| `mcp_ucx/src/mcp_server/project_context.py` | **New** — session state, config default, resolve chain |
| `mcp_ucx/src/mcp_server/tool_registry.py` | 2 tool defs, dispatch, `_PROJECT_TOOLS`, injection in `handle_tool`, descriptions |
| `mcp_ucx/src/mcp_server/executor/registry.py` | Config format migration with backward-compat shim |
| `mcp_ucx/src/mcp_server/cli/main.py` | Env var fallback for `--project`, `get-project` subcommand |
| `mcp_ucx/src/mcp_server/server.py` | Docstring tool count update |
| `mcp_ucx/tests/unit/test_project_context.py` | **New** — 12 tests |
| `mcp_ucx/tests/unit/test_tool_injection.py` | **New** — 5 tests |
| `mcp_ucx/tests/unit/test_server.py` | Tool count 23->25, 3 config format tests |
