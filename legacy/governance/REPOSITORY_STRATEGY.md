...
> [!IMPORTANT]
> All issues, milestones, and labels are tracked in this repo. The [V2 Project Board (#{PROJECT_BOARD_NUMBER})](https://{GITHUB_HOST}/orgs/{GITHUB_ORG}/projects/{PROJECT_BOARD_NUMBER}) pulls issues from this repo. See [GITHUB_PROJECT_SETUP.md](./github/GITHUB_PROJECT_SETUP.md) for AI-optimized workflow setup.
