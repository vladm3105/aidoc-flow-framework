...
ERROR_REGISTRY: Dict[str, Tuple[str, str]] = {
    ...
    # PRD v1.20.0 - Extended error codes for 21-section structure
    "PRD-E010": (
        "Section 10 (Customer-Facing Content) empty or placeholder",
        "Add substantive customer messaging content - this section is BLOCKING",
    ),
    "PRD-E011": (
        "Section 8 missing layer separation note",
        "Add layer separation note distinguishing PRD/EARS/BDD content",
    ),
    "PRD-E012": ("Missing required section", "Add missing section per 21-section PRD template"),
    "PRD-E013": ("Invalid element ID format", "Use PRD.NN.TT.SS format (4-segment)"),
    "PRD-E014": ("Invalid element type code", "Use valid PRD type code (01-09, 11, 22-24)"),
    "PRD-E015": ("SYS-Ready score below threshold", "Improve product completeness to reach threshold"),
    "PRD-E016": ("EARS-Ready score below threshold", "Improve EARS readiness content"),
    "PRD-E017": ("Forward reference to downstream artifact", "Remove ADR/SYS/REQ/SPEC/TASKS references"),
    "PRD-E018": ("BRD traceability format invalid", "Use 4-segment format: @brd: BRD.NN.TT.SS"),
    "PRD-E019": ("Document Control missing required field", "Add all 11 required fields"),
    "PRD-E020": ("Given-When-Then pattern in PRD", "Move BDD patterns to Layer 4 (BDD)"),
    "PRD-E021": ("WHEN-THE-SHALL pattern in PRD", "Move EARS patterns to Layer 3 (EARS)"),
    "PRD-W002": ("File name format incorrect", "Use PRD-NN_descriptive_name.md format"),
    "PRD-W003": ("Missing @diagram: c4-l2 tag", "Add container-level diagram"),
    "PRD-W004": ("Missing @diagram: dfd-l1 tag", "Add data flow level 1 diagram"),
    "PRD-W005": ("Legacy status field detected", "Migrate development_status to status"),
    "PRD-W006": ("Section 20 incomplete", "Add timing profiles, boundary values, fallback paths"),
    "PRD-W007": ("Section 18 missing ADR topics table", "Add ADR topics table without specific ADR-NN refs"),
    "PRD-W020": ("EARS Appendix structure incomplete", "Add all required EARS subsections"),
    "PRD-W021": ("Architecture Decision table missing", "Add ADR topics table in Section 18"),
    "PRD-I001": ("@depends tags detected", "Cross-PRD dependencies noted"),
    "PRD-I002": ("@discoverability tags detected", "AI ranking hints noted"),
    # -------------------------------------------------------------------------
    # CORPUS - Corpus-level (multi-file) PRD validation
    # -------------------------------------------------------------------------
    "CORPUS-E001": ("Placeholder text detected", "Remove TBD, TODO, FIXME, WIP, XXX markers"),
    "CORPUS-E002": ("Forbidden downstream reference", "Remove specific ADR-NN, SYS-NN, REQ-NN references"),
    "CORPUS-E003": ("Internal count mismatch", "Update stated count to match actual items"),
    "CORPUS-E004": ("Index out of sync", "Regenerate index from section files"),
    "CORPUS-E006": ("Missing required diagram type", "Add c4-l2, dfd-l1, or sequence-* diagram"),
    "CORPUS-E007": ("Glossary term inconsistent", "Use consistent terminology across corpus"),
    "CORPUS-E008": ("Duplicate element ID across files", "Ensure all element IDs are unique"),
    "CORPUS-E010": ("File exceeds 1200 lines", "Split into section-based layout"),
    "CORPUS-E011": ("BRD traceability missing", "Add @brd: reference in 4-segment format"),
    "CORPUS-E013": ("Template structure incomplete", "Ensure all 21 sections present"),
    "CORPUS-E014": ("SYS-Ready score below threshold", "Improve product completeness"),
    "CORPUS-E015": ("EARS-Ready score below threshold", "Improve EARS readiness content"),
    "CORPUS-E017": ("Token count exceeds 80K", "Split document into smaller files"),
    "CORPUS-W003": ("Internal count warning", "Verify stated counts match actual"),
    "CORPUS-W009": ("Cost estimate format non-standard", "Use ranges ($100-$150) instead of point estimates"),
    "CORPUS-W010": ("File approaching size limit (800+ lines)", "Consider splitting document"),
    "CORPUS-W012": ("User story coverage gap", "Map BRD objectives to PRD user stories"),
    "CORPUS-W016": ("Glossary path non-standard", "Use standard glossary location"),
    "CORPUS-W017": ("Token count approaching limit (40K+)", "Consider document optimization"),
    "CORPUS-W018": ("YAML frontmatter incomplete", "Add missing required fields"),
    "CORPUS-W019": ("Date format non-ISO", "Use YYYY-MM-DDTHH:MM:SS format"),
    # -------------------------------------------------------------------------
