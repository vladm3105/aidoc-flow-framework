...
```bash
# NOTE: In this ucx_flow_v3 repo, drop any `docs/` prefix shown in generic examples.
...
**Tag Format:** `@brd: BRD.01.b21c, BRD.01.8a81`
...
UCX Flow implements **cumulative tagging** where each artifact type must include traceability tags from ALL upstream artifact types. This creates complete end-to-end traceability chains from business strategy through production deployment.
...
- Multiple Values: comma-separated `@brd: BRD.01.b21c, BRD.01.8a81`
...
@brd: BRD.09.dc1d, BRD.09.1d93
@prd: PRD.16.17a7
@ears: EARS.12.0c24, EARS.12.3a05
@bdd: BDD.15.1cf6, BDD.15.3d46
@adr: ADR-NN
@sys: SYS.12.4e0c, SYS.12.58f8
@req: REQ.45.064d, REQ.45.d37e
@ctr: CTR-NN
@spec: SPEC-NN
@tasks: TASKS.18.dfd9, TASKS.18.2ae3
