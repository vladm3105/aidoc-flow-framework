...
> **Aliases**: `ucx`, `mcp_ucx` (legacy), `sdd-lifecycle`. Package directory: `ucx_hermes/`. The legacy `UCX_v1` archive is a historical predecessor, not the current system.
...
- `ucx_hermes/src/mcp_server/review/runner.py`
- `ucx_hermes/src/mcp_server/validation/runner.py`
- `ucx_hermes/src/mcp_server/remediation/runner.py`
- `ucx_hermes/src/mcp_server/prescreening/runner.py`
- `ucx_hermes/src/mcp_server/scan/runner.py`
- `ucx_hermes/src/mcp_server/scoring/runner.py`
...
| --- | --- | --- |
| `ucx_hermes/skills/personas/` | `{project}/UCX/skills/personas/` | 15 persona definition files |
| `ucx_hermes/skills/persona_mappings.yaml` | `{project}/UCX/skills/persona_mappings.yaml` | Per-doctype, per-phase persona sequence configuration |
| `ucx_hermes/skills/layer_aliases/` | `{project}/UCX/skills/layer_aliases/` | Layer alias mappings |
| `ucx_hermes/prompts/templates/creation/` | `{project}/UCX/prompts/templates/creation/` | UCC creation prompt templates |
| `ucx_hermes/prompts/templates/review/` | `{project}/UCX/prompts/templates/review/` | UCR review prompt templates |
| `ucx_hermes/prompts/templates/remediation/` | `{project}/UCX/prompts/templates/remediation/` | UCRem remediation prompt templates |
| `ucx_hermes/templates/` + `ucx_flow_v3/` | `{project}/UCX/templates/` | Document templates and layer-specific schemas |
...
1. Framework scaffold sources (`ucx_hermes/skills/`, `ucx_hermes/prompts/templates/`) are never loaded by the runtime directly.
...
Prompt assembly tools (`sdd_create_build`, `sdd_create`, `sdd_review`,
`sdd_remediate` with `fix=true`) assemble prompts or deterministic fix
instructions from multiple project-local sources:
...
- `ucx_hermes/docs/policies/MCP_CUTOVER_AND_UCXV1_ARCHIVE_POLICY.md`
