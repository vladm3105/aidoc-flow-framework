...
- `mcp_ucx/src/mcp_server/executor/cli_runner.py` — simplified to single positional-argument delivery
- `mcp_ucx/src/mcp_server/executor/registry.py` — removed `prompt_mode` from all builtin configs
- `mcp_ucx/src/mcp_server/tool_registry.py` — `prompt_file: None`, updated validate detection pattern
- `mcp_ucx/src/mcp_server/validation/runner.py` — `validate_review` → `validate` in report filenames
- `mcp_ucx/src/mcp_server/consistency/runner.py` — updated report path lookup
- `mcp_ucx/src/mcp_server/utils/source_files.py` — removed `validate_review` from `REPORT_PATTERN`
- `mcp_ucx/tests/unit/test_server.py` — updated report filename assertions, removed `prompt_file`
- `mcp_ucx/tests/unit/test_yaml_parity.py` — updated report filename
- `mcp_ucx/tests/unit/test_remediation_runner.py` — updated report filename
- `mcp_ucx/tests/unit/test_cli_main.py` — updated report filenames
- `mcp_ucx/tests/integration/test_migration_flows.py` — updated report glob pattern
- `mcp_ucx/docs/architecture/MCP_CLI_REFERENCE.md` — updated artifact lineage
- `mcp_ucx/docs/architecture/MCP_OPERATIONAL_FLOWS.md` — updated artifact names
- `mcp_ucx/docs/architecture/MCP_UNIFIED_CONTEXT_FRAMEWORK.md` — updated executor section
- `mcp_ucx/docs/CHANGELOG/CHANGELOG_v1.13.0.md` — corrected naming claims
- `mcp_ucx/docs/ROADMAP.md` — corrected v1.13.0 naming, added v1.14.0
- `mcp_ucx/docs/README.md` — updated version, report naming example, changelog list
