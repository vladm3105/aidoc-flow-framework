"""Unified MCP server for ucx_kb tools."""
...
from ucx_kb.graph.adapter import (
    kb_extract,
    kb_extract_text,
    kb_graph_context,
    kb_graph_query,
...
from ucx_kb.rag.adapter import (
    kb_embed,
    kb_embed_text,
    kb_hybrid_context,
    kb_search,
...
TOOLS = [
    Tool(
        name="kb_embed",
        description="Embed a document into ucx_kb RAG",
        inputSchema={
            "type": "object",
            "properties": {
    ...
    Tool(
        name="kb_embed_text",
        description="Embed raw text into ucx_kb RAG",
        inputSchema={
            "type": "object",
            "properties": {
                "text": {"type": "string"},
    ...
    Tool(
        name="kb_status",
        description="Get ucx_kb RAG status",
