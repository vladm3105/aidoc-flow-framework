#!/usr/bin/env python3
"""Pilot validation runner for ucx_kb rollout."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate ucx_kb pilot status")
    parser.add_argument("--out", default="ucx_kb/tmp/pilot_validation.json")
