...
def database_available():
    ...
    try:
        from ucx_kb.rag.schema import health_check
...
class TestEmbeddingRoundTrip:
    ...
    def test_embed_and_search(self, database_available, fixtures_path):
        ...
        from ucx_kb.rag.embed import delete_document, embed_document
        from ucx_kb.rag.search import semantic_search

        earnings_path = fixtures_path / "sample_earnings.yaml"

        with patch("ucx_kb.rag.embed.is_real_document", return_value=True):
...
class TestChunkingPipeline:
    ...
    def test_chunk_earnings_document(self, fixtures_path):
        ...
        from ucx_kb.rag.chunk import chunk_yaml_document

        earnings_path = fixtures_path / "sample_earnings.yaml"

        # Mock section mappings
        with patch("ucx_kb.rag.chunk._section_mappings", {}):
...
class TestHybridContextPipeline:
    ...
    def test_format_context_structure(self):
        ...
        from ucx_kb.rag.hybrid import format_context
        from ucx_kb.rag.models import SearchResult
...
class TestRAGSchemaOperations:
    ...
    def test_schema_init(self, database_available):
        ...
        from ucx_kb.rag.schema import init_schema
    ...
    def test_get_stats(self, database_available):
        ...
        from ucx_kb.rag.search import get_rag_stats
