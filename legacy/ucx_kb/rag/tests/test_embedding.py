...
from ucx_kb.rag.embedding_client import (
    EmbeddingClient,
    get_embedding,
    get_embedding_client,
)
from ucx_kb.rag.exceptions import EmbeddingUnavailableError
...
class TestSingleton:
    ...
    @patch("ucx_kb.rag.embedding_client._client", None)
    @patch("ucx_kb.rag.embedding_client._config", {})
    ...
    def test_convenience_get_embedding(self, mock_post):
        ...
        with patch(
            "ucx_kb.rag.embedding_client._config",
