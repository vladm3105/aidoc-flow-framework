...
| CI/CD pipeline | AI Expert Board (7-persona board) runs on every PR |
| Merge gates | PRs blocked until all P0 expert findings resolved |
...
Author writes/updates doc → PR on feature branch
    → AI Expert Board review (GitHub Actions, 7 personas)
...
|-------------|------------------|------------------------|
| **Any Doc** | `PERSONA_REVIEW` | `bash automation/pipelines/doc_review/run_review.sh <doc>` |
...
Layer 99: Persona Review (Quality Gate)
└── EXPERTS (AI Expert Board Audit Reports generated by 7-persona board)
```
