...
python scripts/generate_traceability_matrix.py --type PRD --output docs/02_PRD/PRD-00_TRACEABILITY_MATRIX.md
```
...
grep -r "@prd: PRD.01" ../03_EARS/

# Find all BDD scenarios referencing PRD-01
grep -r "@prd: PRD.01" ../04_BDD/
...
|--------|--------------|---------------|---------------|--------|
| PRD-01 | 5 | 8 | 100% | [PASS] Complete |
| PRD-02 | 3 | 5 | 100% | [PASS] Complete |
...
- **PRD Template**: [PRD-MVP-TEMPLATE.md](PRD-MVP-TEMPLATE.md) (standard template)
...
- [BRD Traceability Matrix](../01_BRD/BRD-00_TRACEABILITY_MATRIX-TEMPLATE.md)
