...
cp ai_dev_ssd_flow/11_TASKS/IMPLEMENTATION_PLAN_TEMPLATE.md docs/IMPLEMENTATION_PLAN.md
cp ai_dev_ssd_flow/11_TASKS/IMPLEMENTATION_PLAN_TEMPLATE.yaml docs/IMPLEMENTATION_PLAN.yaml
```
...
```
REQ (Layer 7) → SPEC (Layer 9) → TASKS (Layer 10) → Code → Tests
                                        ↓
...
### References
- **Template**: `ai_dev_ssd_flow/11_TASKS/DEVELOPMENT_PLAN_TEMPLATE.md`
- **TASKS Template**: `ai_dev_ssd_flow/11_TASKS/TASKS-TEMPLATE.md`
- **TASKS Documentation**: `ai_dev_ssd_flow/11_TASKS/README.md`
