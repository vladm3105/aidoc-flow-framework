...
|--------|------------|------------|-----------|-------------|-------------|-------------|----------------|--------------|
| ADR-01 | [PASS] Complete | [PASS] Complete | [PASS] Complete | [PASS] Complete | [PASS] Complete | [PASS] Complete | Complete | 100% |
| ADR-02 | [PASS] Complete |  In Progress | ⏳ Pending |  In Progress | ⏳ Pending | ⏳ Pending | In Progress | 60% |
...
- **ADR Template**: [ADR-MVP-TEMPLATE.md](ADR-MVP-TEMPLATE.md) (standard template)
