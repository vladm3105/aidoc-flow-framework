...
| CI/CD pipelines | AI Expert Council review triggered on PR open |
| Merge gates | PR blocked until council audit returns `Proceed` |
...
│  2. AI Expert Council audit (7-persona board)                   │
...
- PRs require green council review before merge
...
```
automation/pipelines/council/run.sh
        │
        ├─ Reads COUNCIL_AUDIT_REPORT.md (generated by GitHub Actions review)
...
2. **No merge without review** — all changes go through PR + AI council
...
5. **Remediation is automated** — council findings become GitHub Issues automatically
