---
title: "EARS Quality Gate Validation"
tags:
...
# EARS Quality Gate Validation Rules
...
| **Quality Gate Validation** | After ALL EARS complete | Entire EARS set | This document |
...
name: EARS Quality Gate Validation
...
# EARS Quality Gate validation on staged EARS files
...
EARS Quality Gate validation should pass before creating BDD documents:
...
- [EARS-MVP-TEMPLATE.md](./EARS-MVP-TEMPLATE.md) - EARS document template (standard template)
