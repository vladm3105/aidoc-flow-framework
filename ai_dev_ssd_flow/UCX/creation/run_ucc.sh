...
LAYER_SKILLS[ears]="requirements_specialist tech_lead qa_lead devils_advocate"
LAYER_SKILLS[bdd]="qa_lead tech_lead devils_advocate operator"
LAYER_SKILLS[adr]="architect tech_lead strategist devils_advocate operator"
