...
# surface. The four-surface table and its measurements live in the header of
# .github/workflows/pin-currency-reader.yml.
#
...
#
# Usage: bash hooks/read-pin-currency-log.sh <path-to-run-log>
#
