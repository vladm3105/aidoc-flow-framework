...
# a pin-currency verdict produced by hooks/read-pin-currency-log.sh.
#
...
#
# Usage:
#   bash hooks/read-pin-currency-log.sh run.log \
#     | bash hooks/reconcile-pin-currency-issue.sh --repo O/R --run-url URL
#
# Options:
