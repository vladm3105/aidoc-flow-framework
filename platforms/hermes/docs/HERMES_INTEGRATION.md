...
- Use UCX MCP tools for `framework` document-layer lifecycle work (BRD through IPLAN).
...
Hermes: Writes to framework/01_BRD/BEE-001.md
...
```
Hermes: sdd_next_action document=framework/01_BRD/BEE-001
...
|-----------|-----------------|
| Hermes MCP Server (`hermes-server`) | `hermes/v0.12.1`+ (spec `0.40.0`+) |
