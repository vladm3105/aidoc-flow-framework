...
metadata:
  ...
  custom_fields:
    ...
    version: "0.4.3"                  # DEFAULT = plugin VERSION (see §3)
...
- A skill's `version` **defaults to the plugin `VERSION`** (currently `0.4.3`)
...
- [ ] `version: "0.4.3"`, `framework_spec_version: "0.11.3"` present.
