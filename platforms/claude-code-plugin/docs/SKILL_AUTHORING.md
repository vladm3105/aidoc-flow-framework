...
metadata:
  ...
  custom_fields:
    ...
    version: "0.6.4"                  # DEFAULT = plugin VERSION (see §3)
...
- A skill's `version` **defaults to the plugin `VERSION`** (currently `0.6.4`)
...
- [ ] `version: "0.6.4"`, `framework_spec_version: "0.13.1"` present.
