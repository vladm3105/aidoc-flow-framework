...
metadata:
  ...
  custom_fields:
    ...
    version: "0.24.0"                  # DEFAULT = plugin VERSION (see §3)
...
- A skill's `version` **defaults to the plugin `VERSION`** (currently `0.24.0`)
...
- [ ] `version: "0.24.0"`, `framework_spec_version: "0.40.0"` present.
