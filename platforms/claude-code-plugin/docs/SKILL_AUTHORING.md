...
metadata:
  ...
  custom_fields:
    ...
    version: "0.20.1"                  # DEFAULT = plugin VERSION (see §3)
...
- A skill's `version` **defaults to the plugin `VERSION`** (currently `0.20.1`)
...
- [ ] `version: "0.20.1"`, `framework_spec_version: "0.21.1"` present.
