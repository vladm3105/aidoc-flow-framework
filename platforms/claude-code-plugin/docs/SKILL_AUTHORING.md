...
metadata:
  ...
  custom_fields:
    ...
    framework_spec_version: "0.32.6"  # = FRAMEWORK_SPEC_VERSION
...
- A skill's `version` **defaults to the plugin `VERSION`** (currently `0.23.0`)
...
- [ ] `version: "0.23.0"`, `framework_spec_version: "0.32.6"` present.
