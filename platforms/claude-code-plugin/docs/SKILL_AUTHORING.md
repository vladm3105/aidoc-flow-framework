...
metadata:
  ...
  custom_fields:
    ...
    version: "0.20.0"                  # DEFAULT = plugin VERSION (see §3)
...
- A skill's `version` **defaults to the plugin `VERSION`** (currently `0.20.0`)
...
- [ ] `version: "0.20.0"`, `framework_spec_version: "0.21.1"` present.
