...
The plugin declares conformance to framework spec `0.35.1`; the canonical
...
| Version | `claude-code-plugin/v0.23.3` (independent SemVer) |
| Conforms to | framework spec `0.35.1` (declared in `FRAMEWORK_SPEC_VERSION`) |
| License | MIT |
