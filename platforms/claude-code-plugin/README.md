...
The plugin declares conformance to framework spec `0.41.0`; the canonical
...
| Version | `claude-code-plugin/v0.25.0` (independent SemVer) |
| Conforms to | framework spec `0.41.0` (declared in `FRAMEWORK_SPEC_VERSION`) |
| License | MIT |
