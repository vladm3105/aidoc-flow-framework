...
The plugin declares conformance to framework spec `0.22.0`; the canonical
...
| Version | `claude-code-plugin/v0.20.1` (independent SemVer) |
| Conforms to | framework spec `0.22.0` (declared in `FRAMEWORK_SPEC_VERSION`) |
| License | MIT |
