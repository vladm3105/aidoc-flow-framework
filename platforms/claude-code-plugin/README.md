...
The plugin declares conformance to framework spec `0.38.0`; the canonical
...
| Version | `claude-code-plugin/v0.23.4` (independent SemVer) |
| Conforms to | framework spec `0.38.0` (declared in `FRAMEWORK_SPEC_VERSION`) |
| License | MIT |
