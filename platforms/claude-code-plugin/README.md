...
The plugin declares conformance to framework spec `0.14.0`; the bundled spec's
...
| Version | `0.6.3` (independent SemVer; tag namespace `claude-code-plugin/v*`) |
| Conforms to | framework spec `0.14.0` (declared in `FRAMEWORK_SPEC_VERSION`) |
| License | MIT |
