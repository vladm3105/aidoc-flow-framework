...
Schema: `framework/TASKS/TASKS_SCHEMA.yaml`
Layer: 11
Artifact Type: TASKS
...
python framework/scripts/validate_tasks.py docs/11_TASKS/TASKS-001_example.md

# Validate all TASKS documents
python framework/scripts/validate_tasks.py docs/11_TASKS/

# Check with verbose output
python framework/scripts/validate_tasks.py docs/11_TASKS/ --verbose
```
