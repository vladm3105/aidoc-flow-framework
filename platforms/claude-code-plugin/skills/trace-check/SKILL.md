...
**Reference**: [TRACEABILITY.md v2.0]({project_root}/framework/TRACEABILITY.md) (updated 2025-10-31)
...
**Reference**: `{project_root}/framework/governance/ID_NAMING_STANDARDS.md`
...
**Primary References**:
- [SPEC_DRIVEN_DEVELOPMENT_GUIDE.md]({project_root}/framework/SPEC_DRIVEN_DEVELOPMENT_GUIDE.md) - Authoritative workflow definition
- [ID_NAMING_STANDARDS.md]({project_root}/framework/governance/ID_NAMING_STANDARDS.md) - ID format rules and conventions
- [TRACEABILITY.md v2.0]({project_root}/framework/TRACEABILITY.md) - Traceability requirements and cumulative tagging standards (updated 2025-10-31)
- [TRACEABILITY_SETUP.md]({project_root}/framework/TRACEABILITY_SETUP.md) - Setup guide for automated validation and CI/CD integration
- [COMPLETE_TAGGING_EXAMPLE.md]({project_root}/framework/COMPLETE_TAGGING_EXAMPLE.md) - End-to-end cumulative tagging example
...
**Template Locations**:
- BRD: `{project_root}/framework/BRD/`
- PRD: `{project_root}/framework/PRD/`
- EARS: `{project_root}/framework/EARS/`
- BDD: `{project_root}/framework/BDD/`
- ADR: `{project_root}/framework/ADR/`
- SYS: `{project_root}/framework/SYS/`
- REQ: `{project_root}/framework/REQ/`
- SPEC: `{project_root}/framework/SPEC/`
...
- [add_cumulative_tagging_to_matrices.py]({project_root}/framework/scripts/add_cumulative_tagging_to_matrices.py) - Adds cumulative tagging sections to traceability matrices
- [batch_update_matrix_templates.py]({project_root}/framework/scripts/batch_update_matrix_templates.py) - Batch updates matrix templates with new features
- [validate_traceability_matrix_enforcement.py]({project_root}/framework/scripts/validate_traceability_matrix_enforcement.py) - Enforces traceability matrix presence and completeness

**Framework Guides**:
- [MATRIX_TEMPLATE_COMPLETION_GUIDE.md]({project_root}/framework/MATRIX_TEMPLATE_COMPLETION_GUIDE.md) - Guide for completing matrix templates with cumulative tagging
