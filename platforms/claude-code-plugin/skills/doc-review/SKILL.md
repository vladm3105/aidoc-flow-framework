...
|-------|------|----------|-------------|---------|
| path | string | Yes | Single file path or folder path to review | `framework/PRD/PRD-001.md`, `docs/EARS/` |
...
```
/doc-review framework/EARS/EARS_CREATION_RULES.md
```

**Output**:
```
=== Documentation Review Report ===
File: framework/EARS/EARS_CREATION_RULES.md
Mode: Single File
Scope: full
...
```
/doc-review framework/PRD/ --focus references,typos
```
