...
- [SPEC_DRIVEN_DEVELOPMENT_GUIDE.md]({project_root}/framework/SPEC_DRIVEN_DEVELOPMENT_GUIDE.md)
- [ADR-TEMPLATE.md]({project_root}/framework/ADR-TEMPLATE.md)
- [ID_NAMING_STANDARDS.md]({project_root}/framework/governance/ID_NAMING_STANDARDS.md)
