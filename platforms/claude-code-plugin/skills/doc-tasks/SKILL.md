...
3. **Template**: `framework/11_TASKS/TASKS-TEMPLATE.md`
4. **Creation Rules**: `framework/11_TASKS/TASKS_CREATION_RULES.md`
5. **Validation Rules**: `framework/11_TASKS/TASKS_VALIDATION_RULES.md`
6. **Validation Script**: `./framework/scripts/validate_tasks.sh`
7. **Implementation Contracts Guide**: `framework/11_TASKS/IMPLEMENTATION_CONTRACTS_GUIDE.md`
...
**Reference**: See `framework/11_TASKS/IMPLEMENTATION_CONTRACTS_GUIDE.md` for detailed guidance.
...
```bash
./framework/scripts/validate_tasks.sh docs/TASKS/TASKS-01_*.md

python framework/scripts/validate_tags_against_docs.py --artifact TASKS-01 --expected-layers brd,prd,ears,bdd,adr,sys,req,impl,contracts,spec --strict
```
...
```
LOOP:
  1. Run: python framework/scripts/validate_cross_document.py --document {doc_path} --auto-fix
...
python framework/scripts/validate_cross_document.py --document docs/TASKS/TASKS-NN_slug.md --auto-fix

# Layer validation (Phase 2) - run when all TASKS documents complete
python framework/scripts/validate_cross_document.py --layer TASKS --auto-fix
```
...
- **Template**: `framework/11_TASKS/TASKS-TEMPLATE.md` (primary authority)
- **TASKS Creation Rules**: `framework/11_TASKS/TASKS_CREATION_RULES.md`
- **TASKS Validation Rules**: `framework/11_TASKS/TASKS_VALIDATION_RULES.md`
- **TASKS README**: `framework/11_TASKS/README.md`
- **Shared Standards**: `.claude/skills/doc-flow/SHARED_CONTENT.md`

**Section Templates** (for documents >25K tokens):
- Index template: `framework/11_TASKS/TASKS-SECTION-0-TEMPLATE.md`
- Content template: `framework/11_TASKS/TASKS-SECTION-TEMPLATE.md`
