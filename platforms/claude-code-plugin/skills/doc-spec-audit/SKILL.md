...
`.aidoc/audit/06_SPEC-audit.md` and an optional fix-cycle trigger.
...
(`.aidoc/audit/06_SPEC-audit.md`) overwritten in place each run — no version cleanup
needed. Keep `SPEC-NN.F_fix_report_v*.md` and `.drift_cache.json`.
...
review → 4) merge/normalize findings → 5) write `.aidoc/audit/06_SPEC-audit.md`
...
Output: `.aidoc/audit/06_SPEC-audit.md`, with sections — **Summary** (ID,
...
consumes the `.aidoc/audit/06_SPEC-audit.md` report.
