...
6. **Validation Script**: `./framework/scripts/validate_ctr.sh`
...
**Reference**: [ID_NAMING_STANDARDS.md - Cross-Reference Link Format](../framework/governance/ID_NAMING_STANDARDS.md#cross-reference-link-format-mandatory)
...
# Cumulative tagging
python framework/scripts/validate_tags_against_docs.py --artifact CTR-01 --expected-layers brd,prd,ears,bdd,adr,sys,req,impl --strict
```
...
./framework/scripts/validate_ctr.sh CTR-01
...
python framework/scripts/validate_cross_document.py --document docs/CTR/CTR-NN_slug.md --auto-fix

# Layer validation (Phase 2) - run when all CTR documents complete
python framework/scripts/validate_cross_document.py --layer CTR --auto-fix
```
