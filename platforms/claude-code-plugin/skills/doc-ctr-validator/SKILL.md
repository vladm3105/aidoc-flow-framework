...
python framework/scripts/validate_ctr.py docs/08_CTR/CTR-001_example.md

# Validate all CTR documents
python framework/scripts/validate_ctr.py docs/08_CTR/

# Check with verbose output
python framework/scripts/validate_ctr.py docs/08_CTR/ --verbose
```
