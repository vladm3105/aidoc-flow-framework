...
Required evidence:
- CLI contract parity check against mcp_sdd/src/mcp_server/cli/main.py
- source mapping behavior review against mcp_sdd/src/mcp_server/prompts/context_builder.py
