...
- [ ] `mcp_sdd/templates/BRD-TEMPLATE.yaml` — format → `{doc_type}.{doc_id}.{hash}`, update examples
- [ ] `mcp_sdd/templates/PRD-TEMPLATE.yaml` — same
- [ ] `mcp_sdd/templates/EARS-TEMPLATE.yaml` — same
- [ ] `mcp_sdd/templates/BDD-TEMPLATE.yaml` — same
- [ ] `mcp_sdd/templates/ADR-TEMPLATE.yaml` — same
- [ ] `mcp_sdd/templates/SYS-TEMPLATE.yaml` — same
- [ ] `mcp_sdd/templates/REQ-TEMPLATE.yaml` — same
- [ ] `mcp_sdd/templates/CTR-TEMPLATE.yaml` — same
- [ ] `mcp_sdd/templates/SPEC-TEMPLATE.yaml` — same + update `element_ids:` section
- [ ] `mcp_sdd/templates/TSPEC-TEMPLATE.yaml` — same
- [ ] `mcp_sdd/templates/TASKS-TEMPLATE.yaml` — same
- [ ] Fix any non-hex hash examples (e.g., `g7k2` → valid hex like `a7f3`)

## Phase 2b: Mirror Templates (11 files)

- [ ] Copy `mcp_sdd/templates/BRD-TEMPLATE.yaml` → `ai_dev_ssd_flow/01_BRD/`
- [ ] Copy `mcp_sdd/templates/PRD-TEMPLATE.yaml` → `ai_dev_ssd_flow/02_PRD/`
- [ ] Copy `mcp_sdd/templates/EARS-TEMPLATE.yaml` → `ai_dev_ssd_flow/03_EARS/`
- [ ] Copy `mcp_sdd/templates/BDD-TEMPLATE.yaml` → `ai_dev_ssd_flow/04_BDD/`
- [ ] Copy `mcp_sdd/templates/ADR-TEMPLATE.yaml` → `ai_dev_ssd_flow/05_ADR/`
- [ ] Copy `mcp_sdd/templates/SYS-TEMPLATE.yaml` → `ai_dev_ssd_flow/06_SYS/`
- [ ] Copy `mcp_sdd/templates/REQ-TEMPLATE.yaml` → `ai_dev_ssd_flow/07_REQ/`
- [ ] Copy `mcp_sdd/templates/CTR-TEMPLATE.yaml` → `ai_dev_ssd_flow/08_CTR/`
- [ ] Copy `mcp_sdd/templates/SPEC-TEMPLATE.yaml` → `ai_dev_ssd_flow/09_SPEC/`
- [ ] Copy `mcp_sdd/templates/TSPEC-TEMPLATE.yaml` → `ai_dev_ssd_flow/10_TSPEC/`
- [ ] Copy `mcp_sdd/templates/TASKS-TEMPLATE.yaml` → `ai_dev_ssd_flow/11_TASKS/`
...
### Creation prompts
- [ ] `mcp_sdd/prompts/templates/creation/UCC_PROMPT_BRD.md` — update ID format
- [ ] `mcp_sdd/prompts/templates/creation/UCC_PROMPT_PRD.md` — **HIGH**: remove "4-segment" instruction
- [ ] `mcp_sdd/prompts/templates/creation/UCC_PROMPT_EARS.md` — update ID examples
- [ ] `mcp_sdd/prompts/templates/creation/UCC_PROMPT_BDD.md` — update ID examples
- [ ] `mcp_sdd/prompts/templates/creation/UCC_PROMPT_TSPEC.md` — update ID examples
- [ ] `mcp_sdd/prompts/templates/creation/UCC_OUTPUT_SCHEMA.md` — update output format

### Review prompts
- [ ] `mcp_sdd/prompts/templates/review/UCR_PROMPT_BRD.md` — update ID refs

### Remediation prompts
- [ ] `mcp_sdd/prompts/templates/remediation/UCRem_PROMPT_BRD.md` — update ID refs
- [ ] `mcp_sdd/prompts/templates/remediation/UCRem_PROMPT_PRD.md` — update ID refs
- [ ] `mcp_sdd/prompts/templates/remediation/UCRem_PROMPT_EARS.md` — update ID refs
- [ ] `mcp_sdd/prompts/templates/remediation/UCRem_PROMPT_ADR.md` — update ID refs
...
## Phase 7: mcp_sdd Persona Skills

- [ ] Check `mcp_sdd/skills/personas/*.md` (14 files) — update if any ID format refs

## Phase 8: mcp_sdd Source & Tests

- [ ] `mcp_sdd/src/mcp_server/validation/runner.py` — update element ID regex if present
- [ ] `mcp_sdd/src/mcp_server/tool_registry.py` — check for ID format refs
...
- [ ] UPDATE `mcp_sdd/docs/README.md` — add v1.6.0 changelog entry
- [ ] Check `mcp_sdd/docs/architecture/MCP_CLI_REFERENCE.md` for ID examples
- [ ] Check `mcp_sdd/docs/specs/SPEC-003_mcp_creation_validation_profile_contracts.md` for ID format
- [ ] Check `mcp_sdd/skills/README.md` for ID format refs

### mcp_sdd Changelog & Roadmap
- [ ] UPDATE `mcp_sdd/docs/ROADMAP.md` — v1.5.0 → v1.6.0
- [ ] CREATE `mcp_sdd/docs/CHANGELOG/CHANGELOG_v1.6.0.md`

## Phase 11: Final Review

- [ ] Run: `grep -rP '[A-Z]{2,8}\.\d{2,}\.\d{2,}\.[0-9a-f]{2,}' ai_dev_ssd_flow/ mcp_sdd/ .claude/ --include='*.md' --include='*.yaml' | grep -v archive | grep -v v1_archive` → 0 matches
