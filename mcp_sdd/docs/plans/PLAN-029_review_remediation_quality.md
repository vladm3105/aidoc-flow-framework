...
## Part A: Framework Fixes (mcp_sdd codebase — applies to ALL projects)
...
- File: `mcp_sdd/src/mcp_server/remediation/runner.py` (lines 341-348)
...
- File: `mcp_sdd/skills/persona_mappings.yaml` (line 50)
- Change: `personas: [architect, auditor, business_analyst, chaos_engineer, fact_checker, chairperson]`
- Rationale: fact_checker persona already exists in framework (`mcp_sdd/skills/personas/fact_checker.md`) with "Scope Misunderstanding" detection — just not wired into BRD review flow
...
- File: `mcp_sdd/skills/personas/chairperson.md`
...
- File: `mcp_sdd/skills/personas/auditor.md`
...
- File: `mcp_sdd/src/mcp_server/remediation/review_parser.py` (line 71: `_clean_text`)
...
- File: `mcp_sdd/src/mcp_server/remediation/runner.py` (`_build_remediate_fix_prompt`, lines 287-351)
...
- File: `mcp_sdd/src/mcp_server/remediation/runner.py` (`_build_remediate_fix_prompt`)
...
- File: `mcp_sdd/src/mcp_server/remediation/runner.py` (finding cap logic, ~line 520)
...
- File: `mcp_sdd/src/mcp_server/tool_registry.py` (`_handle_lifecycle_pipeline`)
...
- File: `mcp_sdd/src/mcp_server/remediation/runner.py` (new function `verify_remediation_quality`)
