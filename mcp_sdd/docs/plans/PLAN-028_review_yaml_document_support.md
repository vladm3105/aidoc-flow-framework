...
All in `mcp_sdd/src/mcp_server/cli/main.py`:
...
| File | Action |
| --- | --- |
| `mcp_sdd/src/mcp_server/cli/main.py` | Edit — 4 functions fixed |
| `mcp_sdd/tests/unit/test_review_document_collection.py` | **Create** — ~8 tests |
