...
| --- | --- | --- | --- | --- |
| Preflight command tests | mcp_sdd/tests/unit/test_cli_main.py; mcp_sdd/tests/unit/test_preflight_runner.py | Completed | ai-agent | 2026-03-27 |
| Telemetry output tests | mcp_sdd/tests/unit/test_remediation_runner.py | Completed | ai-agent | 2026-03-27 |
| Operator workflow updates | mcp_sdd/docs/architecture/MCP_OPERATOR_RUNBOOK.md | Completed | ai-agent | 2026-03-27 |
