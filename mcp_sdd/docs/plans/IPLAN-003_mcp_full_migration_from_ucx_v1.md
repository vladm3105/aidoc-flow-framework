...
3. `mcp_sdd/src/mcp_server/validation/*`
4. `mcp_sdd/src/mcp_server/remediation/*` (new)
5. `mcp_sdd/src/mcp_server/prescreening/*` (new)
6. `mcp_sdd/src/mcp_server/scoring/*` (new)
7. `mcp_sdd/src/mcp_server/scan/*` (new)
...
1. `mcp_sdd/tests/unit/test_cli_main.py`
2. `mcp_sdd/tests/unit/test_validation_runner.py`
3. `mcp_sdd/tests/unit/test_remediation_runner.py` (new)
4. `mcp_sdd/tests/unit/test_prescreening.py` (new)
5. `mcp_sdd/tests/unit/test_scoring_cli.py` (new)
6. `mcp_sdd/tests/integration/test_migration_flows.py` (new)
...
1. `mcp_sdd/docs/architecture/MCP_UNIFIED_CONTEXT_FRAMEWORK.md`
...
3. `mcp_sdd/docs/specs/SPEC-009_mcp_remediation_and_fix_flow_contracts.md`
4. `mcp_sdd/docs/specs/SPEC-010_mcp_prescreen_scan_scoring_contracts.md`
5. `mcp_sdd/docs/policies/MCP_CUTOVER_AND_UCXV1_ARCHIVE_POLICY.md`

Update existing spec:

1. `mcp_sdd/docs/specs/SPEC-008_mcp_output_schema_contracts.md`
...
2. `mcp_sdd/docs/architecture/MCP_RUNTIME_ARCHITECTURE.md`
3. `mcp_sdd/docs/architecture/MCP_OPERATOR_RUNBOOK.md`
4. `mcp_sdd/docs/README.md`
5. `mcp_sdd/docs/ROADMAP.md`
6. `mcp_sdd/docs/CHANGELOG/CHANGELOG_v1.0.0.md` (or next release changelog file)
...
4. Baseline `MCP_CUTOVER_AND_UCXV1_ARCHIVE_POLICY.md` is published and referenced from `mcp_sdd/docs/README.md`.
...
3. Documentation and policy verification:
   ...
   - `rg -n "UCX_v1|UCX v1|ucx_v1|UCX" mcp/docs --glob "*.md" --glob "!mcp_sdd/docs/policies/MCP_CUTOVER_AND_UCXV1_ARCHIVE_POLICY.md"`
...
5. Active release tracking record: `mcp_sdd/docs/plans/IPLAN-003_RELEASE_TRACKING.yaml`.
...
5. Closure artifact: `mcp_sdd/docs/plans/IPLAN-003_MIGRATION_CLOSURE_REPORT.md`.
