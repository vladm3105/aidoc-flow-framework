...
**Target**: mcp_sdd v1.7.0 / docs_flow_framework v0.14.0
...
- [ ] **0.1** Run existing test suite — all must pass before any changes
  ```bash
  cd /opt/data/docs_flow_framework && python -m pytest mcp_sdd/tests/unit/ -v
  ```
...
### File: `mcp_sdd/src/mcp_server/validation/cross_section.py` — CREATE (~200 lines)
...
### File: `mcp_sdd/src/mcp_server/validation/brd_rules.py` — CREATE (~200 lines)
...
### File: `mcp_sdd/src/mcp_server/validation/runner.py` — MODIFY (+80-100 lines)
...
### File: `mcp_sdd/src/mcp_server/validation/__init__.py` — MODIFY
...
### File: `mcp_sdd/tests/unit/test_cross_section.py` — CREATE (~200 lines)
...
### File: `mcp_sdd/tests/unit/test_brd_rules.py` — CREATE (~250 lines)
...
### File: `mcp_sdd/templates/BRD-TEMPLATE.yaml` — MODIFY (+40 lines)
...
- [ ] **6.2** Add `cross_section_rules` to existing `metadata` section:
  ```yaml
    cross_section_rules:
      description: "Machine-enforced by sdd_validate (mcp_sdd)"
      generic:
        - id: SDD-XS-001
...
### File: `mcp_sdd/templates/BRD-MD-TEMPLATE.md` — CREATE (~120 lines)
...
- [ ] **8.5** Verify template sync:
  ```bash
  diff mcp_sdd/templates/BRD-TEMPLATE.yaml ai_dev_ssd_flow/01_BRD/BRD-TEMPLATE.yaml
  ```
...
- [x] **9.1** Created `mcp_sdd/docs/plans/PLAN-016_cross_section_validation.md`
- [x] **9.2** Created `mcp_sdd/docs/CHANGELOG/CHANGELOG_v1.7.0.md`
- [x] **9.3** Updated `mcp_sdd/docs/README.md` — added PLAN-016 + CHANGELOG v1.7.0 links
- [x] **9.4** Updated `mcp_sdd/docs/ROADMAP.md` — added v1.7.0 planned release
...
- [ ] **10.3** Commit with message:
  ```
  feat(mcp_sdd): add cross-section validation rules (PLAN-016)
