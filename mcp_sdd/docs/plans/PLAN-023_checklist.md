...
**File**: `mcp_sdd/src/mcp_server/tool_registry.py`, `_dispatch()` (line 549)
...
**File**: `mcp_sdd/src/mcp_server/tool_registry.py`, handler at line 559
...
- [ ] Run: `PYTHONPATH=mcp_sdd/src python -c "from mcp_server.tool_registry import TOOLS; print([t.name for t in TOOLS])"` — confirm `sdd_validate_fix` not in list, `sdd_validate` present
...
**File**: `mcp_sdd/src/mcp_server/tool_registry.py` (lines 488-495 only — do NOT touch 496-499 `elif source_files:`)
...
**File**: `mcp_sdd/src/mcp_server/tool_registry.py` (lines 887-893)

- [ ] Change `"validate_fix"` mapping from `"sdd_validate_fix"` to `"sdd_validate"`

### 2.3 Add Pipeline Absorption Logic
**File**: `mcp_sdd/src/mcp_server/tool_registry.py`, `_handle_lifecycle_pipeline()` (before line 907)
...
**File**: `mcp_sdd/src/mcp_server/tool_registry.py`, `sdd_run_lifecycle` tool (line 220)
...
**File**: `mcp_sdd/src/mcp_server/cli/main.py` (lines 115-130)
...
- [ ] Run: `cd /opt/data/docs_flow_framework && PYTHONPATH=mcp_sdd/src pytest mcp_sdd/tests/ -x -v`
...
**File**: `mcp_sdd/docs/architecture/MCP_OPERATIONAL_FLOWS.md`
...
**File**: `mcp_sdd/docs/architecture/MCP_OPERATOR_RUNBOOK.md`
...
### 6.4 Test Suite
- [ ] `pytest mcp_sdd/tests/ -x -v` — all pass
