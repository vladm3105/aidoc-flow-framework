...
| File | Action |
|------|--------|
| `mcp_sdd/src/mcp_server/skills/persona_manager.py` | **Created** |
| `mcp_sdd/src/mcp_server/skills/scaffold.py` | `--update` / `--update-mappings` modes |
| `mcp_sdd/src/mcp_server/tool_registry.py` | 3 Tool defs + dispatch (22 tools total) |
| `mcp_sdd/src/mcp_server/preflight/runner.py` | Health check integration |
| `mcp_sdd/src/mcp_server/cli/main.py` | 3 subcommands + init flags |
| `mcp_sdd/src/mcp_server/validation/brd_rules.py` | BRD-XS-004 rewritten |
| `mcp_sdd/src/mcp_server/remediation/runner.py` | Remove executive_summary from required keys |
| `ai_dev_ssd_flow/01_BRD/BRD-TEMPLATE.yaml` | executive_summary: required: false |
| `mcp_sdd/tests/unit/test_persona_manager.py` | **Created** — 15 tests |
| `mcp_sdd/tests/unit/test_scaffold_init.py` | +3 tests |
| `mcp_sdd/tests/unit/test_brd_rules.py` | Updated entity tests |
| `mcp_sdd/tests/unit/test_preflight_runner.py` | +1 test |
