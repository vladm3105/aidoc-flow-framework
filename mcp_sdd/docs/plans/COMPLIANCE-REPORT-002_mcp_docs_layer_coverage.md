...
- Coverage matrix: mcp_sdd/docs/plans/DOC-COVERAGE-MATRIX-001_mcp_layers.md
- Reconciliation log: mcp_sdd/docs/plans/DOC-RECONCILIATION-LOG-001.md
- Canonical specs: mcp_sdd/docs/specs/SPEC-001 through SPEC-007
- Policies: mcp_sdd/docs/policies/legacy_report_policy.md and DOC_* policy set
- Architecture docs: mcp_sdd/docs/architecture/MCP_* set
...
- CLI contract parity signals:
	- init, create-build, review-build parser contracts located in mcp_sdd/src/mcp_server/cli/main.py
