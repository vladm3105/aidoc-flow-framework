...
**New file**: `mcp_sdd/src/mcp_server/skills/persona_manager.py`
...
**File**: `mcp_sdd/src/mcp_server/validation/brd_rules.py`
...
**File**: `mcp_sdd/src/mcp_server/remediation/runner.py`
...
| File | Change |
|------|--------|
| `mcp_sdd/src/mcp_server/skills/persona_manager.py` | **New** — show, set, diff, health check |
| `mcp_sdd/src/mcp_server/skills/scaffold.py` | Add `--update` / `--update-mappings` modes, `PROTECTED_PROJECT_FILES` |
| `mcp_sdd/src/mcp_server/skills/__init__.py` | Export 4 persona_manager functions |
| `mcp_sdd/src/mcp_server/tool_registry.py` | 3 new Tool defs + dispatch blocks (22 tools total) |
| `mcp_sdd/src/mcp_server/preflight/runner.py` | Persona mapping health check integration |
| `mcp_sdd/src/mcp_server/cli/main.py` | 3 subcommands + init flags + formatting helpers |
| `mcp_sdd/src/mcp_server/validation/brd_rules.py` | BRD-XS-004 rewritten |
| `mcp_sdd/src/mcp_server/remediation/runner.py` | Remove executive_summary from BRD required keys |
| `ai_dev_ssd_flow/01_BRD/BRD-TEMPLATE.yaml` | executive_summary: required: false |
| `mcp_sdd/tests/unit/test_persona_manager.py` | **New** — 14 tests |
| `mcp_sdd/tests/unit/test_scaffold_init.py` | +3 tests (update, protected, update-mappings) |
| `mcp_sdd/tests/unit/test_brd_rules.py` | Updated entity consistency tests |
| `mcp_sdd/tests/unit/test_preflight_runner.py` | +1 health check test |
| `mcp_sdd/tests/unit/test_server.py` | Tool count 19→22 |
