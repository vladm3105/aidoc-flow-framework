...
- `mcp_sdd/src/mcp_server/consistency/runner.py` — updated artifact name patterns
- `mcp_sdd/src/mcp_server/utils/source_files.py` — updated `_validated` suffix exclusion
- `mcp_sdd/docs/README.md` — updated report naming example, version, changelog list
- `mcp_sdd/docs/ROADMAP.md` — added v1.13.0 entry
- `mcp_sdd/docs/architecture/MCP_OPERATIONAL_FLOWS.md` — updated artifact names, pipeline stages, lineage chain
- `mcp_sdd/docs/architecture/MCP_OPERATOR_RUNBOOK.md` — updated validate and validate-fix sections
- `mcp_sdd/docs/architecture/MCP_CLI_REFERENCE.md` — updated validate-fix deprecation, artifact lineage, examples
