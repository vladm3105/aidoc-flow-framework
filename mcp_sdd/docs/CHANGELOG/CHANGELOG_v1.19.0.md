...
| File | Change |
|------|--------|
| `mcp_sdd/src/mcp_server/cli/main.py` | 4 functions fixed: `_list_review_document_candidates`, `_find_canonical_source`, `_collect_review_document_files`, `_build_review_sections_from_document` |
| `mcp_sdd/tests/unit/test_review_document_collection.py` | **New** — 16 tests |
