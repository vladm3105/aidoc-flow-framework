...
Ensures all mcp_sdd tools handle YAML documents on par with MD documents. Introduces categorized scoring weights, result class API aliases, YAML structure validation in remediation, and a shared source file collector.
