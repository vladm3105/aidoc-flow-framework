...
```bash
ln -sfn /opt/data/ucx_framework/framework framework
...
| Framework script path | `framework/layers/01_BRD/scripts/` |

## Failure Modes

| Failure | Cause | Resolution |
| --- | --- | --- |
| Script path not found | Missing `framework` link | Recreate symlink |
