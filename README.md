...
| **Claude Code plugin** | Native Claude Code (skills / agents / commands) | `claude-code-plugin/v0.4.4` (`platforms/claude-code-plugin/`) |
...
`0.11.3`. The Claude Code plugin (`platforms/claude-code-plugin/`) is currently a **pre-1.0 preview** (v0.4.4); APIs and surfaces may change before 1.0. The framework spec is stable at `0.11.3`. Post-v1.0 work to date:
