...
| **Claude Code plugin** | Native Claude Code (skills / agents / commands) | `claude-code-plugin/v0.20.1` (`platforms/claude-code-plugin/`) |
...
framework spec `0.22.0`. The Claude Code plugin is a **pre-1.0 preview** — APIs
