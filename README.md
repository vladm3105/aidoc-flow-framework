...
| **Claude Code plugin** | Native Claude Code (skills / agents / commands) | `claude-code-plugin/v0.13.1` (`platforms/claude-code-plugin/`) |
...
framework spec `0.17.0`. The Claude Code plugin is a **pre-1.0 preview** — APIs
