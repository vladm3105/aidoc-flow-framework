...
| **Claude Code plugin** | Native Claude Code (skills / agents / commands) | `claude-code-plugin/v0.23.2` (`platforms/claude-code-plugin/`) |
...
framework spec `0.34.1`. The Claude Code plugin is a **pre-1.0 preview** — APIs
