...
**Context**: Preparing for production.
**Goal**: Define **Reliability Engineering Standards**.

## Instructions
1.  **SLIs/SLOs**: Define Service Level Indicators and Objectives.
    *   *Example*: "99.9% of requests < 200ms".
2.  **Error Budget**: How much failure is acceptable per quarter?
3.  **Observability**: What metrics, logs, and traces are required?
4.  **Incident Response**: Who gets paged? What is the escalation path?

## Output Format
*   **SLO Table**: Indicator | Objective | Measurement Window.
*   **Monitoring Strategy**: List of critical alerts.
