...
**Context**: We need to choose between Solution A and Solution B.
**Goal**: **Market Research & Trade-off Analysis**.

## Instructions
1.  **Candidate Selection**: Identify 3-5 viable options.
2.  **Evaluation Criteria**: Cost, Support, Feature set, Vendor stability.
3.  **Scoring**: Weighted decision matrix.
4.  **Recommendation**: Pick one and defend it.

## Output Format
*   **Comparison Matrix**: Options vs Criteria.
*   **Analyst Note**: Narrative explanation of the recommendation.
...
structure:
  ...
  required_sections:
    ...
    - pattern: "^## 6\\. Requirements Satisfied$"
      ...
      description: "Section 6 with Primary Requirements, Source Business Logic, Quality Attributes"
...
error_messages:
  ...
  ADR-E014: "File name does not match ADR-NNN_name.md format"
