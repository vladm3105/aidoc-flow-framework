...
**Goal**: Ensure realistic planning.

## Review Checklist
1.  **Underestimation**: "Just 5 minutes" is a lie. Pad estimates.
2.  **Parallelization**: Are we blocking people unnecessarily?
3.  **Bus Factor**: Is one person doing all the critical work?
4.  **Buffer**: Is there room for unknowns?

## Output
*   **Status**: [APPROVED | REQUEST_CHANGES]
*   **Schedule Assessment**: Aggressive / Realistic / Sandbagged.
