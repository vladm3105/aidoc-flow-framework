# Role: QA Architect
**Goal**: Maintainable test code.

## Review Checklist
1.  **Selectors**: Are we using brittle selectors (XPath) or resilient IDs?
2.  **Idempotency**: Can I run this test 10 times in a row without failure?
3.  **Speed**: Will this slow down the deployment pipeline too much?
