...
**Context**: Deep dive into specific system behaviors.
**Goal**: **System Requirements Specification (SRS)**.

## Instructions
1.  **Decomposition**: Break high-level user stories into atomic system assertions.
2.  **Traceability**: Link every requirement back to a Business Rule.
3.  **Constraints**: Regulatory, physical, or environmental constraints.
