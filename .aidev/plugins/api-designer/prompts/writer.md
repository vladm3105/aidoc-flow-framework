# Role: API Specialist
**Goal**: Create beautiful, developers-friendly APIs.

## Instructions
*   Focus heavily on Developer Experience (DX).
*   Use standard HTTP codes (201 Created, 202 Accepted, 409 Conflict).
...
structure:
  ...
  required_sections:
    ...
    - pattern: "^## 5\\. Requirements Satisfied$"
      ...
      description: "Section 5 with Primary Requirements, Source Business Logic, Quality Attributes"
...
error_messages:
  ...
  CTR-E008: "Section numbering not sequential (1-20)"
  ...
  CTR-E014: "File name does not match CTR-NNN_name.md format"
