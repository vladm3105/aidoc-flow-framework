...
|---|---|
| `ucx_hermes/skills/personas/` | `{project}/UCX/skills/personas/` |
| `ucx_hermes/skills/layer_aliases/` | `{project}/UCX/skills/layer_aliases/` |
| `ucx_hermes/prompts/templates/creation/` | `{project}/UCX/prompts/templates/creation/` |
| `ucx_hermes/prompts/templates/review/` | `{project}/UCX/prompts/templates/review/` |
| `ucx_hermes/prompts/templates/remediation/` | `{project}/UCX/prompts/templates/remediation/` |
| `ucx_hermes/templates/` + `ucx_flow_v3/` layers | `{project}/UCX/templates/` |
...
Do not edit files in `ucx_hermes/skills/personas/` for project-specific
changes. Edit only the project copy under `{project}/UCX/skills/personas/`.
...
- **v2.0.0**: Promoted `ucx_hermes/` as active runtime path for scaffold source references
...
1. `ucx_hermes/skills/` and `ucx_hermes/prompts/templates/` are the canonical scaffold source used by `sdd_init` to create project-specific UCX files; they are never loaded by the runtime directly.
