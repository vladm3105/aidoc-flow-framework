...
from ucx_knowledge.graph.exceptions import GraphUnavailableError
from ucx_knowledge.graph.layer import TradingGraph
from ucx_knowledge.graph.models import GraphStats


class TestTradingGraphConnection:
    """Tests for Neo4j connection handling."""

    @patch("ucx_knowledge.graph.layer.GraphDatabase")
