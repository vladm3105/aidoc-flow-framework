...
from ucx_knowledge.graph.exceptions import ExtractionError
from ucx_knowledge.graph.extract import (
...
from ucx_knowledge.graph.models import EntityExtraction, ExtractionResult
...
class TestApplyConfidenceThresholds:
    ...
    def test_high_confidence_kept(self):
        ...
        with patch(
            "ucx_knowledge.graph.extract._config",
...
class TestExtractDocument:
    ...
    @patch("ucx_knowledge.graph.extract.is_real_document")
...
class TestExtractText:
    ...
    @patch("ucx_knowledge.graph.extract._call_ollama_rate_limited")
    @patch(
        "ucx_knowledge.graph.extract._config",
