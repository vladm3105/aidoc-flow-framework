...
from ucx_knowledge.rag.hybrid import (
...
from ucx_knowledge.rag.models import HybridContext, SearchResult
...
class TestGetHybridContext:
    ...
    @patch("ucx_knowledge.rag.hybrid.get_similar_analyses")
    @patch("ucx_knowledge.rag.hybrid.semantic_search")
    @patch("ucx_knowledge.rag.hybrid.get_learnings_for_topic")
    def test_combines_sources(self, mock_learnings, mock_search, mock_similar):
        ...
        with patch("ucx_knowledge.graph.layer.TradingGraph") as mock_graph:
...
class TestBuildAnalysisContext:
    ...
    @patch("ucx_knowledge.rag.hybrid.get_hybrid_context")
