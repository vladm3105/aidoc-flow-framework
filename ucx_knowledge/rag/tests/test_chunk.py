...
from ucx_knowledge.rag.chunk import (
    _get_nested_value,
    _infer_doc_type,
    chunk_yaml_document,
    chunk_yaml_section,
...
from ucx_knowledge.rag.exceptions import ChunkingError
...
class TestChunkYamlDocument:
    ...
    @patch("ucx_knowledge.rag.chunk._section_mappings", {})
    @patch(
    ...
    @patch(
        "ucx_knowledge.rag.chunk._section_mappings",
        {
            "earnings-analysis": {
