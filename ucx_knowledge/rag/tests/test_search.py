...
from ucx_knowledge.rag.exceptions import RAGUnavailableError
from ucx_knowledge.rag.models import RAGStats, SearchResult
from ucx_knowledge.rag.search import (
    _build_hybrid_query,
    _build_search_query,
    get_document_chunks,
...
class TestSemanticSearch:
    ...
    @patch("ucx_knowledge.rag.search.get_embedding")
...
class TestGetSimilarAnalyses:
    ...
    @patch("ucx_knowledge.rag.search.semantic_search")
