...
from ucx_knowledge.rag.embedding_client import (
    EmbeddingClient,
    get_embedding,
    get_embedding_client,
)
from ucx_knowledge.rag.exceptions import EmbeddingUnavailableError
...
class TestSingleton:
    ...
    @patch("ucx_knowledge.rag.embedding_client._client", None)
    @patch("ucx_knowledge.rag.embedding_client._config", {})
    ...
    def test_convenience_get_embedding(self, mock_post):
        ...
        with patch(
            "ucx_knowledge.rag.embedding_client._config",
