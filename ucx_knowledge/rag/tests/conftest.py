...
def mock_embedding_client():
    ...
    with patch("ucx_knowledge.rag.embedding_client.requests.post") as mock_post:
...
def mock_config():
    ...
    with patch("ucx_knowledge.rag.embed._config", config):
        with patch("ucx_knowledge.rag.embedding_client._config", config):
            yield config
