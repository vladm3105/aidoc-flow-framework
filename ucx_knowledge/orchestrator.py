"""Ingestion orchestrator for ucx_knowledge."""
...
from ucx_knowledge.graph.adapter import kb_extract
from ucx_knowledge.rag.adapter import kb_embed
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run ucx_knowledge ingestion pipeline")
