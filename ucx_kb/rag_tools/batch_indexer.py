#!/usr/bin/env python3
"""Batch indexer for ucx_kb contract jobs.
...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description="Generate ucx_kb indexing jobs")
    parser.add_argument("--source", required=True, help="Source directory to scan")
    parser.add_argument("--service", choices=["rag", "graph", "both"],
                       default="both", help="Which ucx_kb pipeline to target")
