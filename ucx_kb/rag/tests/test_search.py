...
from ucx_kb.rag.exceptions import RAGUnavailableError
from ucx_kb.rag.models import RAGStats, SearchResult
from ucx_kb.rag.search import (
    _build_hybrid_query,
    _build_search_query,
    get_document_chunks,
...
class TestSemanticSearch:
    ...
    @patch("ucx_kb.rag.search.get_embedding")
...
class TestGetSimilarAnalyses:
    ...
    @patch("ucx_kb.rag.search.semantic_search")
