...
def mock_embedding_client():
    ...
    with patch("ucx_kb.rag.embedding_client.requests.post") as mock_post:
...
def mock_config():
    ...
    with patch("ucx_kb.rag.embed._config", config):
        with patch("ucx_kb.rag.embedding_client._config", config):
            yield config
