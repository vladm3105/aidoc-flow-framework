...
from ucx_kb.graph.exceptions import ExtractionError
from ucx_kb.graph.extract import (
...
from ucx_kb.graph.models import EntityExtraction, ExtractionResult
...
class TestExtractDocument:
    ...
    @patch("ucx_kb.graph.extract.is_real_document")
...
class TestExtractText:
    ...
    @patch("ucx_kb.graph.extract._call_ollama_rate_limited")
    @patch(
        "ucx_kb.graph.extract._config",
