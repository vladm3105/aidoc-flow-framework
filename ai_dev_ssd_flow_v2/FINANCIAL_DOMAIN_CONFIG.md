...
- `@req: REQ.01.a45b`: Real-time position aggregation
- `@req: REQ.02.2131`: Market data integration for notional calculations
- `@adr: ADR-005`: Real-time risk architecture decision

### Downstream Dependencies
- `@spec: SPEC-03`: resource limiter technical specification
- `@bdd: BDD.03.0836`: resource limit acceptance tests
...
| `@tasks: TASKS.03.64dd` | Implementation Tasks | AI generation tasks |
| `@bdd: BDD.03.0836` | BDD Scenarios | Acceptance tests |
...
### BDD Scenarios
- `@bdd: BDD.03.0836`: Comprehensive limit enforcement scenarios
