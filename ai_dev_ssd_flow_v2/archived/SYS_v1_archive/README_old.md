...
- id: sys-core-validator
  ...
  entry: bash ucx_flow_v3/06_SYS/scripts/sys_core_validator_hook.sh ucx_flow_v3/06_SYS
  language: system
...
- id: sys-quality-gate
  ...
  entry: bash ucx_flow_v3/06_SYS/scripts/sys_quality_gate_hook.sh ucx_flow_v3/06_SYS
  language: system
  pass_filenames: false
  stages: [pre-commit]
...
- id: sys-req-ready-score
  ...
  entry: bash ucx_flow_v3/06_SYS/scripts/sys_req_ready_score_hook.sh ucx_flow_v3/06_SYS
  language: system
  pass_filenames: false
  stages: [pre-commit]
```
