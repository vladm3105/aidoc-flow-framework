...
**Artifacts**: `01_BRD/BRD-TEMPLATE.yaml`, `BRD-TEMPLATE.yaml`
...
**Artifacts**: `02_PRD/PRD-TEMPLATE.yaml`, `PRD-TEMPLATE.yaml`
...
**Artifacts**: `03_EARS/EARS-TEMPLATE.yaml`, `EARS-TEMPLATE.yaml`
...
**Artifacts**: `04_BDD/BDD-TEMPLATE.yaml`, `BDD-TEMPLATE.yaml`
...
**Artifacts**: `07_REQ/REQ-TEMPLATE.yaml`, `REQ-TEMPLATE.yaml`
...
4. **BDD Generation** → `BDD-01_trading_bot.yaml`
...
- Run tests based on `BDD-01_trading_bot.yaml` scenarios
...
ucx_flow_v3/
 ...
 04_BDD/BDD-01_trading_bot.yaml          (Test scenarios)
