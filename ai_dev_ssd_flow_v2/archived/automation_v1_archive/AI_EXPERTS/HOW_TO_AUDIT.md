...
1.  **Prepare your Project Configuration**: Copy `review.template.yaml` to `docs/AI_EXPERTS/review.yaml`. Fill it out with your project's specific personas and anti-bias directives.
...
> **Board Configuration**: docs/AI_EXPERTS/review.yaml
