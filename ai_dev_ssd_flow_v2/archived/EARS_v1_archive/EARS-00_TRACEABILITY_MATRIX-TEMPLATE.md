...
python scripts/generate_traceability_matrix.py --type EARS --output docs/03_EARS/EARS-00_TRACEABILITY_MATRIX.md
```
...
|---------|------------------|---------------|--------------|----------------|--------|
| EARS-01 | 5 | 5 | 5 | 100% | [PASS] Verified |
| EARS-NN | 3 | 3 | 3 | 100% | [PASS] Verified |
...
|---------|------------|------------|------------|----------------|--------------|
| EARS-01 | [PASS] Complete | [PASS] Complete | N/A | Complete | 100% |
| EARS-NN | [PASS] Complete |  In Progress | [PASS] Complete | In Progress | 80% |
| EARS-NN |  In Progress | ⏳ Pending | ⏳ Pending | Started | 30% |
| EARS-NN | ... | ... | ... | ... | ... |

**Status Legend**:
- [PASS] Complete: Artifact created and validated
-  In Progress: Artifact under development
- ⏳ Pending: Artifact not yet started
- N/A: Not applicable for this EARS
- [FAIL] Blocked: Artifact creation blocked by dependencies
...
- **EARS Template**: [EARS-MVP-TEMPLATE.md](EARS-MVP-TEMPLATE.md) (standard template)
...
- [BDD Traceability Matrix](../04_BDD/BDD-00_TRACEABILITY_MATRIX-TEMPLATE.md)
