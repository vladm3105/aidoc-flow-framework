...
python3 ucx_flow_v3/03_EARS/scripts/validate_ears.py --path ucx_flow_v3/03_EARS --profile mvp

# Full validation (explicit)
python3 ucx_flow_v3/03_EARS/scripts/validate_ears.py --path ucx_flow_v3/03_EARS --profile full
```
