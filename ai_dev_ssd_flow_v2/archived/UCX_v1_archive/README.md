...
|---------|------|---------|
| 1.21.7 | 2026-03-22 | **PRD fixer coverage expansion & LLM handoff alignment**: Added deterministic PRD fixer coverage for `PRD-W006`, `PRD-W011`, `PRD-W012`, `PRD-W019`, and `PRD-W021`. Added PRD LLM handoff routing for `PRD-W004`, `PRD-W009`, `PRD-W013`, `PRD-W014` with manual action generation. Updated Section 14 launch criteria template to avoid invalid `PRD.NN.14.xx` IDs. See [CHANGELOG_v1.21.7](docs/CHANGELOG/CHANGELOG_v1.21.7.md). |
...
**Latest Release**: v1.21.7 - PRD fixer coverage expansion and LLM handoff alignment
- Added deterministic PRD fixer coverage for `PRD-W006`, `PRD-W011`, `PRD-W012`, `PRD-W019`, `PRD-W021`
- Added PRD LLM-only handoff action routing for `PRD-W004`, `PRD-W009`, `PRD-W013`, `PRD-W014`
- Updated Section 14 launch-criteria fixer template to avoid invalid `PRD.NN.14.xx` element IDs
- Zero breaking changes; behavior is additive and compatible with existing validate/remediate flows
- See [CHANGELOG_v1.21.7](docs/CHANGELOG/CHANGELOG_v1.21.7.md) for details
...
**Previous Latest Release**: v1.21.6 - Validation source protection and report-only safety
...
**Previous Release**: v1.21.5 - AI preflight probe robustness and formatting drift tolerance
...
| [CHANGELOG v1.21.7](docs/CHANGELOG/CHANGELOG_v1.21.7.md) | PRD fixer coverage expansion and LLM handoff alignment |
...
| [PLAN-013](docs/plans/PLAN-013_prd_fix_plan_generalization.md) | PRD fix-plan template generalization and historical preservation |
