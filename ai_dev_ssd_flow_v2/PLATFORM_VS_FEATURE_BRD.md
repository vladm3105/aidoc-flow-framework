...
BRDs fall into two categories based on their focus. Both use the same template (BRD-TEMPLATE.yaml) but with different emphasis on technology prerequisites.
...
**See Also**:
- [BRD-TEMPLATE.yaml](./01_BRD/BRD-TEMPLATE.yaml) - Unified template for both types
