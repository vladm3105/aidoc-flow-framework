...
cp ucx_flow_v3/11_TASKS/IMPLEMENTATION_PLAN_TEMPLATE.md docs/IMPLEMENTATION_PLAN.md
cp ucx_flow_v3/11_TASKS/IMPLEMENTATION_PLAN_TEMPLATE.yaml docs/IMPLEMENTATION_PLAN.yaml
```
...
### References
- **Template**: `ucx_flow_v3/11_TASKS/DEVELOPMENT_PLAN_TEMPLATE.md`
- **TASKS Template**: `ucx_flow_v3/11_TASKS/TASKS-TEMPLATE.md`
- **TASKS Documentation**: `ucx_flow_v3/11_TASKS/README.md`
